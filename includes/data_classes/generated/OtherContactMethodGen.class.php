<?php
	...
	class OtherContactMethodGen extends QBaseClass {
		...
		public static function QuerySingle(QQCondition $objConditions, $objOptionalClauses = null, $mixParameterArray = null) {
			...
			// Perform the Query, Get the First Row, and Instantiate a new OtherContactMethod object
			$objDbResult = $objQueryBuilder->Database->Query($strQuery);
			return OtherContactMethod::InstantiateDbRow($objDbResult->GetNextRow(), null, null, null, $objQueryBuilder->ColumnAliasArray);
		}
