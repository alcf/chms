<?php
	...
	class CheckingAccountLookupGen extends QBaseClass {
		...
		public static function QuerySingle(QQCondition $objConditions, $objOptionalClauses = null, $mixParameterArray = null) {
			...
			// Perform the Query, Get the First Row, and Instantiate a new CheckingAccountLookup object
			$objDbResult = $objQueryBuilder->Database->Query($strQuery);
			return CheckingAccountLookup::InstantiateDbRow($objDbResult->GetNextRow(), null, null, null, $objQueryBuilder->ColumnAliasArray);
		}
