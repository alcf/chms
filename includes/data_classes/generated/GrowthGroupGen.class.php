<?php
	...
	class GrowthGroupGen extends QBaseClass {
		...
		public static function QuerySingle(QQCondition $objConditions, $objOptionalClauses = null, $mixParameterArray = null) {
			...
			// Perform the Query, Get the First Row, and Instantiate a new GrowthGroup object
			$objDbResult = $objQueryBuilder->Database->Query($strQuery);
			return GrowthGroup::InstantiateDbRow($objDbResult->GetNextRow(), null, null, null, $objQueryBuilder->ColumnAliasArray);
		}
