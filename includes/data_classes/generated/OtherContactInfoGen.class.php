...
/*		public static function QueryArrayCached($strConditions, $mixParameterArray = null) {
		...
		*/
		...
		public function Journal($strJournalCommand) {
			$objDatabase = OtherContactInfo::GetDatabase()->JournalingDatabase;
		...
		public static function GetJournalForId($intId) {
			...
			$objResult = $objDatabase->Query('SELECT * FROM other_contact_info WHERE id = ' .
				$objDatabase->SqlVariable($intId) . ' ORDER BY __sys_date');

			return OtherContactInfo::InstantiateDbResult($objResult);
		}
		...
		public function GetJournal() {
			return OtherContactInfo::GetJournalForId($this->intId);
		}
	 ...
	 * @property-read QQNode $OtherContactMethodId
	 * @property-read QQNodeOtherContactMethod $OtherContactMethod
