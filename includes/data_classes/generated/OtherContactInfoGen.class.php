<?php
	...
	class OtherContactInfoGen extends QBaseClass {
		...
		public static function QuerySingle(QQCondition $objConditions, $objOptionalClauses = null, $mixParameterArray = null) {
			...
			// Perform the Query, Get the First Row, and Instantiate a new OtherContactInfo object
			$objDbResult = $objQueryBuilder->Database->Query($strQuery);
			return OtherContactInfo::InstantiateDbRow($objDbResult->GetNextRow(), null, null, null, $objQueryBuilder->ColumnAliasArray);
		}
