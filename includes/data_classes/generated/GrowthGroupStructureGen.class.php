<?php
	...
	class GrowthGroupStructureGen extends QBaseClass {
		...
		public static function QuerySingle(QQCondition $objConditions, $objOptionalClauses = null, $mixParameterArray = null) {
			...
			// Instantiate a new GrowthGroupStructure object and return it

			// Do we have to expand anything?
			if ($objQueryBuilder->ExpandAsArrayNodes) {
				$objToReturn = array();
				while ($objDbRow = $objDbResult->GetNextRow()) {
					$objItem = GrowthGroupStructure::InstantiateDbRow($objDbRow, null, $objQueryBuilder->ExpandAsArrayNodes, $objToReturn, $objQueryBuilder->ColumnAliasArray);
				...
				return GrowthGroupStructure::InstantiateDbRow($objDbRow, null, null, null, $objQueryBuilder->ColumnAliasArray);
			}
		}
...
/*		public static function QueryArrayCached($strConditions, $mixParameterArray = null) {
		...
		*/
		...
		public static function GetJournalForId($intId) {
			$objResult = QApplication::$Database[2]->Query('SELECT * FROM growth_group_structure WHERE id = ' .
				QApplication::$Database[2]->SqlVariable($intId) . ' ORDER BY __sys_date');

			return GrowthGroupStructure::InstantiateDbResult($objResult);
		}
		...
		public function GetJournal() {
			return GrowthGroupStructure::GetJournalForId($this->intId);
		}
		...
		*/
		...
		/**
		 * Gets the historical journal for an object's GrowthGroup relationship from the log database.
		 * @param integer intId
		 * @return QDatabaseResult $objResult
		 */
		public static function GetJournalGrowthGroupAssociationForId($intId) {
			return QApplication::$Database[2]->Query('SELECT * FROM growthgroupstructure_growthgroup_assn WHERE growth_group_structure_id = ' .
				QApplication::$Database[2]->SqlVariable($intId) . ' ORDER BY __sys_date');
		}
