<?php
	...
	class ParentPagerPeriodGen extends QBaseClass {
		...
		/**
		 * Protected member variable that maps to the database PK Identity column parent_pager_period.id
		 * @var integer intId
		 */
		protected $intId;
		...
		public function Save($blnForceInsert = false, $blnForceUpdate = false) {
			...
			try {
				if ((!$this->__blnRestored) || ($blnForceInsert)) {
					...
					$mixToReturn = $this->intId = $objDatabase->InsertId('parent_pager_period', 'id');
