<?php
	...
	class StewardshipContributionAmountGen extends QBaseClass {
		...
		public static function QuerySingle(QQCondition $objConditions, $objOptionalClauses = null, $mixParameterArray = null) {
			...
			// Perform the Query, Get the First Row, and Instantiate a new StewardshipContributionAmount object
			$objDbResult = $objQueryBuilder->Database->Query($strQuery);
			return StewardshipContributionAmount::InstantiateDbRow($objDbResult->GetNextRow(), null, null, null, $objQueryBuilder->ColumnAliasArray);
		}
