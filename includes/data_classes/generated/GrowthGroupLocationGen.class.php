<?php
	...
	class GrowthGroupLocationGen extends QBaseClass {
		...
		public static function QuerySingle(QQCondition $objConditions, $objOptionalClauses = null, $mixParameterArray = null) {
			...
			// Perform the Query, Get the First Row, and Instantiate a new GrowthGroupLocation object
			$objDbResult = $objQueryBuilder->Database->Query($strQuery);
			return GrowthGroupLocation::InstantiateDbRow($objDbResult->GetNextRow(), null, null, null, $objQueryBuilder->ColumnAliasArray);
		}
