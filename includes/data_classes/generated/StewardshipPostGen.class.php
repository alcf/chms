<?php
	...
	class StewardshipPostGen extends QBaseClass {
		...
		public static function QuerySingle(QQCondition $objConditions, $objOptionalClauses = null, $mixParameterArray = null) {
			...
			// Perform the Query, Get the First Row, and Instantiate a new StewardshipPost object
			$objDbResult = $objQueryBuilder->Database->Query($strQuery);
			return StewardshipPost::InstantiateDbRow($objDbResult->GetNextRow(), null, null, null, $objQueryBuilder->ColumnAliasArray);
		}
