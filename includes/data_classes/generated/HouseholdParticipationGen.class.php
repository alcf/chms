<?php
	...
	class HouseholdParticipationGen extends QBaseClass {
		...
		public static function QuerySingle(QQCondition $objConditions, $objOptionalClauses = null, $mixParameterArray = null) {
			...
			// Perform the Query, Get the First Row, and Instantiate a new HouseholdParticipation object
			$objDbResult = $objQueryBuilder->Database->Query($strQuery);
			return HouseholdParticipation::InstantiateDbRow($objDbResult->GetNextRow(), null, null, null, $objQueryBuilder->ColumnAliasArray);
		}
