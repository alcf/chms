<?php
	/**
	 * The abstract EventSignupFormGen class defined here is
	 * code-generated and contains all the basic CRUD-type functionality as well as
	 * basic methods to handle relationships and index-based loading.
	 *
	 * To use, you should use the EventSignupForm subclass which
	 * extends this EventSignupFormGen class.
	 *
	 * Because subsequent re-code generations will overwrite any changes to this
	 * file, you should leave this file unaltered to prevent yourself from losing
	 * any information or code changes.  All customizations should be done by
	 * overriding existing or implementing new methods, properties and variables
	 * in the EventSignupForm class.
	 * 
	 * @package ALCF ChMS
	 ...
	 */
	class EventSignupFormGen extends QBaseClass {
		...
		/**
		 * Protected member variable that maps to the database PK column event_signup_form.signup_form_id
		...
		/**
		 * Protected member variable that maps to the database column event_signup_form.date_start
		...
		/**
		 * Protected member variable that maps to the database column event_signup_form.date_end
		...
		/**
		 * Protected member variable that maps to the database column event_signup_form.location
		 ...
		 * in the database column event_signup_form.signup_form_id.
		 *
		...
		/**
		 * Load a EventSignupForm from PK Info
		...
		/**
		 * Load all EventSignupForms
		 * @param QQClause[] $objOptionalClauses additional optional QQClause objects for this query
		 * @return EventSignupForm[]
		 */
		public static function LoadAll($objOptionalClauses = null) {
			// Call EventSignupForm::QueryArray to perform the LoadAll query
			try {
				return EventSignupForm::QueryArray(QQ::All(), $objOptionalClauses);
		...
		/**
		 * Count all EventSignupForms
		 * @return int
		 */
		public static function CountAll() {
			// Call EventSignupForm::QueryCount to perform the CountAll query
			return EventSignupForm::QueryCount(QQ::All());
		}
		...
		protected static function BuildQueryStatement(&$objQueryBuilder, QQCondition $objConditions, $objOptionalClauses, $mixParameterArray, $blnCountOnly) {
			...
			// Create/Build out the QueryBuilder object with EventSignupForm-specific SELET and FROM fields
			$objQueryBuilder = new QQueryBuilder($objDatabase, 'event_signup_form');
			EventSignupForm::GetSelectFields($objQueryBuilder);
			$objQueryBuilder->AddFromItem('event_signup_form');
		...
		/**
		 * Static Qcodo Query method to query for a single EventSignupForm object.
		 * Uses BuildQueryStatment to perform most of the work.
		 * @param QQCondition $objConditions any conditions on the query, itself
		 * @param QQClause[] $objOptionalClauses additional optional QQClause objects for this query
		 * @param mixed[] $mixParameterArray a array of name-value pairs to perform PrepareStatement with
		 * @return EventSignupForm the queried object
		 */
		public static function QuerySingle(QQCondition $objConditions, $objOptionalClauses = null, $mixParameterArray = null) {
			// Get the Query Statement
			try {
				$strQuery = EventSignupForm::BuildQueryStatement($objQueryBuilder, $objConditions, $objOptionalClauses, $mixParameterArray, false);
			} catch (QCallerException $objExc) {
				$objExc->IncrementOffset();
				throw $objExc;
			}
			...
			// Instantiate a new EventSignupForm object and return it

			// Do we have to expand anything?
			if ($objQueryBuilder->ExpandAsArrayNodes) {
				$objToReturn = array();
				while ($objDbRow = $objDbResult->GetNextRow()) {
					$objItem = EventSignupForm::InstantiateDbRow($objDbRow, null, $objQueryBuilder->ExpandAsArrayNodes, $objToReturn, $objQueryBuilder->ColumnAliasArray);
				...
				return EventSignupForm::InstantiateDbRow($objDbRow, null, null, null, $objQueryBuilder->ColumnAliasArray);
			}
		}

		/**
		 * Static Qcodo Query method to query for an array of EventSignupForm objects.
		 * Uses BuildQueryStatment to perform most of the work.
		 * @param QQCondition $objConditions any conditions on the query, itself
		 * @param QQClause[] $objOptionalClauses additional optional QQClause objects for this query
		 * @param mixed[] $mixParameterArray a array of name-value pairs to perform PrepareStatement with
		 * @return EventSignupForm[] the queried objects as an array
		 */
		public static function QueryArray(QQCondition $objConditions, $objOptionalClauses = null, $mixParameterArray = null) {
			...
			$objDbResult = $objQueryBuilder->Database->Query($strQuery);
			return EventSignupForm::InstantiateDbResult($objDbResult, $objQueryBuilder->ExpandAsArrayNodes, $objQueryBuilder->ColumnAliasArray);
		}
		...
		/**
		 * Static Qcodo Query method to query for a count of EventSignupForm objects.
		 * Uses BuildQueryStatment to perform most of the work.
		 * @param QQCondition $objConditions any conditions on the query, itself
		 * @param QQClause[] $objOptionalClauses additional optional QQClause objects for this query
		 * @param mixed[] $mixParameterArray a array of name-value pairs to perform PrepareStatement with
		...
		public static function QueryCount(QQCondition $objConditions, $objOptionalClauses = null, $mixParameterArray = null) {
			// Get the Query Statement
			try {
				$strQuery = EventSignupForm::BuildQueryStatement($objQueryBuilder, $objConditions, $objOptionalClauses, $mixParameterArray, true);
			} catch (QCallerException $objExc) {
				$objExc->IncrementOffset();
				throw $objExc;
			}
...
/*		public static function QueryArrayCached($strConditions, $mixParameterArray = null) {
			...
			$objCache = new QCache('query', 'event_signup_form_' . serialize($strConditions));
			if (!($strQuery = $objCache->GetData())) {
				// Not Found -- Go ahead and Create/Build out a new QueryBuilder object with EventSignupForm-specific fields
				$objQueryBuilder = new QQueryBuilder($objDatabase);
				EventSignupForm::GetSelectFields($objQueryBuilder);
				EventSignupForm::GetFromFields($objQueryBuilder);
		...
		/**
		 * Updates a QQueryBuilder with the SELECT fields for this EventSignupForm
		...
		public static function GetSelectFields(QQueryBuilder $objBuilder, $strPrefix = null) {
			if ($strPrefix) {
				...
				$strTableName = 'event_signup_form';
				$strAliasPrefix = '';
			}
		...
		/**
		 * Instantiate a EventSignupForm from a Database Row.
		 * Takes in an optional strAliasPrefix, used in case another Object::InstantiateDbRow
		 * is calling this EventSignupForm::InstantiateDbRow in order to perform
		...
		*/
		public static function InstantiateDbRow($objDbRow, $strAliasPrefix = null, $strExpandAsArrayNodes = null, $objPreviousItem = null, $strColumnAliasArray = array()) {
			...
			// Create a new instance of the EventSignupForm object
			$objToReturn = new EventSignupForm();
			...
			if (!$strAliasPrefix)
				$strAliasPrefix = 'event_signup_form__';
		...
		/**
		 * Instantiate an array of EventSignupForms from a Database Result
		...
		public static function InstantiateDbResult(QDatabaseResultBase $objDbResult, $strExpandAsArrayNodes = null, $strColumnAliasArray = null) {
			...
			if ($strExpandAsArrayNodes) {
				$objLastRowItem = null;
				while ($objDbRow = $objDbResult->GetNextRow()) {
					$objItem = EventSignupForm::InstantiateDbRow($objDbRow, null, $strExpandAsArrayNodes, $objLastRowItem, $strColumnAliasArray);
					if ($objItem) {
						$objToReturn[] = $objItem;
				...
				while ($objDbRow = $objDbResult->GetNextRow())
					$objToReturn[] = EventSignupForm::InstantiateDbRow($objDbRow, null, null, null, $strColumnAliasArray);
			}
		...
		/**
		 * Instantiate a single EventSignupForm object from a query cursor (e.g. a DB ResultSet).
		 * Cursor is automatically moved to the "next row" of the result set.
		 * Will return NULL if no cursor or if the cursor has no more rows in the resultset.
		 * @param QDatabaseResultBase $objDbResult cursor resource
		 * @return EventSignupForm next row resulting from the query
		 */
		public static function InstantiateCursor(QDatabaseResultBase $objDbResult) {
			...
			return EventSignupForm::InstantiateDbRow($objDbRow, null, $strExpandAsArrayNodes, null, $strColumnAliasArray);
		}
		...
		/**
		 * Load a single EventSignupForm object,
		...
		*/
		...
		/**
		 * Delete this EventSignupForm
		 * @return void
		 */
		public function Delete() {
			if ((is_null($this->intSignupFormId)))
				throw new QUndefinedPrimaryKeyException('Cannot delete this EventSignupForm with an unset primary key.');
		...
		/**
		 * Truncate event_signup_form table
		 * @return void
		 */
		...
		public function Journal($strJournalCommand) {
			$objDatabase = EventSignupForm::GetDatabase()->JournalingDatabase;
		...
		public static function GetJournalForId($intSignupFormId) {
			...
			$objResult = $objDatabase->Query('SELECT * FROM event_signup_form WHERE signup_form_id = ' .
				$objDatabase->SqlVariable($intSignupFormId) . ' ORDER BY __sys_date');

			return EventSignupForm::InstantiateDbResult($objResult);
		}
		...
		public function GetJournal() {
			return EventSignupForm::GetJournalForId($this->intSignupFormId);
		}
				...
				case 'SignupForm':
					...
					if (is_null($mixValue)) {
						...
						if (is_null($mixValue->Id))
							throw new QCallerException('Unable to set an unsaved SignupForm for this EventSignupForm');
		...
		public static function GetSoapComplexTypeXml() {
			$strToReturn = '<complexType name="EventSignupForm"><sequence>';
		...
		public static function AlterSoapComplexTypeArray(&$strComplexTypeArray) {
			if (!array_key_exists('EventSignupForm', $strComplexTypeArray)) {
				$strComplexTypeArray['EventSignupForm'] = EventSignupForm::GetSoapComplexTypeXml();
		...
		public static function GetArrayFromSoapArray($objSoapArray) {
			...
			foreach ($objSoapArray as $objSoapObject)
				array_push($objArrayToReturn, EventSignupForm::GetObjectFromSoapObject($objSoapObject));
	 ...
	 */
	class QQNodeEventSignupForm extends QQNode {
		protected $strTableName = 'event_signup_form';
		protected $strPrimaryKey = 'signup_form_id';
		protected $strClassName = 'EventSignupForm';
		public function __get($strName) {
			switch ($strName) {
				case 'SignupFormId':
	 ...
	 */
	class QQReverseReferenceNodeEventSignupForm extends QQReverseReferenceNode {
		protected $strTableName = 'event_signup_form';
		protected $strPrimaryKey = 'signup_form_id';
		protected $strClassName = 'EventSignupForm';
		public function __get($strName) {
