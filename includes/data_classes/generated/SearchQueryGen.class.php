<?php
	...
	class SearchQueryGen extends QBaseClass {
		...
		public static function QuerySingle(QQCondition $objConditions, $objOptionalClauses = null, $mixParameterArray = null) {
			...
			// Perform the Query, Get the First Row, and Instantiate a new SearchQuery object
			$objDbResult = $objQueryBuilder->Database->Query($strQuery);
			return SearchQuery::InstantiateDbRow($objDbResult->GetNextRow(), null, null, null, $objQueryBuilder->ColumnAliasArray);
		}
