<?php
	...
	class EmailMessageRouteGen extends QBaseClass {
		...
		public static function QuerySingle(QQCondition $objConditions, $objOptionalClauses = null, $mixParameterArray = null) {
			...
			// Perform the Query, Get the First Row, and Instantiate a new EmailMessageRoute object
			$objDbResult = $objQueryBuilder->Database->Query($strQuery);
			return EmailMessageRoute::InstantiateDbRow($objDbResult->GetNextRow(), null, null, null, $objQueryBuilder->ColumnAliasArray);
		}
