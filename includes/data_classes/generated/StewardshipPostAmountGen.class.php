<?php
	...
	class StewardshipPostAmountGen extends QBaseClass {
		...
		public static function QuerySingle(QQCondition $objConditions, $objOptionalClauses = null, $mixParameterArray = null) {
			...
			// Perform the Query, Get the First Row, and Instantiate a new StewardshipPostAmount object
			$objDbResult = $objQueryBuilder->Database->Query($strQuery);
			return StewardshipPostAmount::InstantiateDbRow($objDbResult->GetNextRow(), null, null, null, $objQueryBuilder->ColumnAliasArray);
		}
