<?php
	...
	class StewardshipStackGen extends QBaseClass {
		...
		public static function QuerySingle(QQCondition $objConditions, $objOptionalClauses = null, $mixParameterArray = null) {
			...
			// Perform the Query, Get the First Row, and Instantiate a new StewardshipStack object
			$objDbResult = $objQueryBuilder->Database->Query($strQuery);
			return StewardshipStack::InstantiateDbRow($objDbResult->GetNextRow(), null, null, null, $objQueryBuilder->ColumnAliasArray);
		}
