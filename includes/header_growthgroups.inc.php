...
<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="en">
	...
	<div style="width: 100%; height: 100px; border-top: 1px solid #321;">
		<div style="width: 980px; margin: auto;">
			<a href="http://www.alcf.net/" title="ALCF Home"><div style="width: 80px; cursor: pointer; background: url(/images/alcflogo-80x80.jpg) no-repeat; height: 80px; float: left; margin-top:20px; ">
				&nbsp;
			</div></a>
