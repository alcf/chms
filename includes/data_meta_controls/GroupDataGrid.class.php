<?php
	require(__DATAGEN_META_CONTROLS__ . '/GroupDataGridGen.class.php');

	/**
	 * This is the "Meta" DataGrid customizable subclass for the List functionality
	 * of the Group class.  This code-generated class extends
	 * from the generated Meta DataGrid class which contains a QDataGrid class which
	 * can be used by any QForm or QPanel, listing a collection of Group
	 ...
	 * 
	 */
	class GroupDataGrid extends GroupDataGridGen {
	}
?>