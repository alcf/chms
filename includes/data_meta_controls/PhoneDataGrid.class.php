<?php
	require(__DATAGEN_META_CONTROLS__ . '/PhoneDataGridGen.class.php');

	/**
	 * This is the "Meta" DataGrid customizable subclass for the List functionality
	 * of the Phone class.  This code-generated class extends
	 * from the generated Meta DataGrid class which contains a QDataGrid class which
	 * can be used by any QForm or QPanel, listing a collection of Phone
	 ...
	 * 
	 */
	class PhoneDataGrid extends PhoneDataGridGen {
	}
?>