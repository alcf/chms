<?php
	 ...
	 * listing a collection of ClassifiedPost objects.  It includes
	 ...
	 * 
	 */
	class ClassifiedPostDataGridGen extends QDataGrid {
		/**
		 ...
		 * way of adding a column to this ClassifiedPost datagrid.  The description of a column's
		 * content can be either a text string description of a simple field name
		 * in the ClassifiedPost object, or it can be any QQNode extending from QQN::ClassifiedPost().
		 * 
		 ...
		 * sorting using two fields from the ClassifiedPost object.
		 *
		 ...
		 *
		 * @param mixed $mixContent string or QQNode from ClassifiedPost
		...
		public function MetaDataBinder(QQCondition $objCondition = null, $objOptionalClauses = null) {
			...
			if ($this->Paginator) $this->TotalItemCount = ClassifiedPost::QueryCount($objCondition, $objClauses);
		 ...
		 *
		 * Given a QQNode or a Text String, this will return a ClassifiedPost-based QQNode.
		 * It will also verify that it is a proper ClassifiedPost-based QQNode, and will throw an exception otherwise.
		 *
		...
		protected function ResolveContentItem($mixContent) {
			if ($mixContent instanceof QQNode) {
				...
				if ($mixContent->_RootTableName == 'classified_post') {
					...
					throw new QCallerException('Content QQNode has a root table of "' . $mixContent->_RootTableName . '". Must be a root of "classified_post".');
				...
				case 'DateExpired': return QQN::ClassifiedPost()->DateExpired;
				case 'Name': return QQN::ClassifiedPost()->Name;
				case 'Phone': return QQN::ClassifiedPost()->Phone;
				case 'Email': return QQN::ClassifiedPost()->Email;
				default: throw new QCallerException('Simple Property not found in ClassifiedPostDataGrid content: ' . $mixContent);
