<?php
	 ...
	 * listing a collection of CreditCardPayment objects.  It includes
	 ...
	 * 
	 */
	class CreditCardPaymentDataGridGen extends QDataGrid {
		/**
		 ...
		 * way of adding a column to this CreditCardPayment datagrid.  The description of a column's
		 * content can be either a text string description of a simple field name
		 * in the CreditCardPayment object, or it can be any QQNode extending from QQN::CreditCardPayment().
		 * 
		 ...
		 * sorting using two fields from the CreditCardPayment object.
		 *
		 ...
		 *
		 * @param mixed $mixContent string or QQNode from CreditCardPayment
		...
		public function MetaDataBinder(QQCondition $objCondition = null, $objOptionalClauses = null) {
			...
			if ($this->Paginator) $this->TotalItemCount = CreditCardPayment::QueryCount($objCondition, $objClauses);
		 ...
		 *
		 * Given a QQNode or a Text String, this will return a CreditCardPayment-based QQNode.
		 * It will also verify that it is a proper CreditCardPayment-based QQNode, and will throw an exception otherwise.
		 *
		...
		protected function ResolveContentItem($mixContent) {
			if ($mixContent instanceof QQNode) {
				...
				if ($mixContent->_RootTableName == 'credit_card_payment') {
				...
				default: throw new QCallerException('Simple Property not found in CreditCardPaymentDataGrid content: ' . $mixContent);
