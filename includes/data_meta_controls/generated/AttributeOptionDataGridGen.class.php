<?php
	 ...
	 * listing a collection of AttributeOption objects.  It includes
	 ...
	 * 
	 */
	class AttributeOptionDataGridGen extends QDataGrid {
		/**
		 ...
		 * way of adding a column to this AttributeOption datagrid.  The description of a column's
		 * content can be either a text string description of a simple field name
		 * in the AttributeOption object, or it can be any QQNode extending from QQN::AttributeOption().
		 * 
		 ...
		 * sorting using two fields from the AttributeOption object.
		 *
		 ...
		 *
		 * @param mixed $mixContent string or QQNode from AttributeOption
		...
		public function MetaDataBinder() {
			...
			if ($this->Paginator) {
				$this->TotalItemCount = AttributeOption::CountAll();
			}
			...
			$this->DataSource = AttributeOption::LoadAll($objClauses);
		}
		...
		protected function ResolveContentItem($mixContent) {
			if ($mixContent instanceof QQNode) {
				...
				case 'Id': return QQN::AttributeOption()->Id;
				case 'AttributeId': return QQN::AttributeOption()->AttributeId;
				case 'Attribute': return QQN::AttributeOption()->Attribute;
				case 'Name': return QQN::AttributeOption()->Name;
				default: throw new QCallerException('Simple Property not found in AttributeOptionDataGrid content: ' . $mixContent);
