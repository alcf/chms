<?php
	 ...
	 * listing a collection of NameItem objects.  It includes
	 ...
	 * 
	 */
	class NameItemDataGridGen extends QDataGrid {
		/**
		 ...
		 * way of adding a column to this NameItem datagrid.  The description of a column's
		 * content can be either a text string description of a simple field name
		 * in the NameItem object, or it can be any QQNode extending from QQN::NameItem().
		 * 
		 ...
		 * sorting using two fields from the NameItem object.
		 *
		 ...
		 *
		 * @param mixed $mixContent string or QQNode from NameItem
		...
		public function MetaDataBinder(QQCondition $objCondition = null, $objOptionalClauses = null) {
			...
			if ($this->Paginator) $this->TotalItemCount = NameItem::QueryCount($objCondition, $objClauses);
		 ...
		 *
		 * Given a QQNode or a Text String, this will return a NameItem-based QQNode.
		 * It will also verify that it is a proper NameItem-based QQNode, and will throw an exception otherwise.
		 *
		...
		protected function ResolveContentItem($mixContent) {
			if ($mixContent instanceof QQNode) {
				...
				if ($mixContent->_RootTableName == 'name_item') {
					...
					throw new QCallerException('Content QQNode has a root table of "' . $mixContent->_RootTableName . '". Must be a root of "name_item".');
			} else if (is_string($mixContent)) switch ($mixContent) {
				case 'Id': return QQN::NameItem()->Id;
				case 'Name': return QQN::NameItem()->Name;
				default: throw new QCallerException('Simple Property not found in NameItemDataGrid content: ' . $mixContent);
