<?php
	 ...
	 * listing a collection of ParentPagerAttendantHistory objects.  It includes
	 ...
	 * 
	 */
	class ParentPagerAttendantHistoryDataGridGen extends QDataGrid {
		/**
		 ...
		 * way of adding a column to this ParentPagerAttendantHistory datagrid.  The description of a column's
		 * content can be either a text string description of a simple field name
		 * in the ParentPagerAttendantHistory object, or it can be any QQNode extending from QQN::ParentPagerAttendantHistory().
		 * 
		 ...
		 * sorting using two fields from the ParentPagerAttendantHistory object.
		 *
		 ...
		 *
		 * @param mixed $mixContent string or QQNode from ParentPagerAttendantHistory
		...
		public function MetaDataBinder(QQCondition $objCondition = null, $objOptionalClauses = null) {
			...
			if ($this->Paginator) $this->TotalItemCount = ParentPagerAttendantHistory::QueryCount($objCondition, $objClauses);
		 ...
		 *
		 * Given a QQNode or a Text String, this will return a ParentPagerAttendantHistory-based QQNode.
		 * It will also verify that it is a proper ParentPagerAttendantHistory-based QQNode, and will throw an exception otherwise.
		 *
		...
		protected function ResolveContentItem($mixContent) {
			if ($mixContent instanceof QQNode) {
				...
				if ($mixContent->_RootTableName == 'parent_pager_attendant_history') {
					...
					throw new QCallerException('Content QQNode has a root table of "' . $mixContent->_RootTableName . '". Must be a root of "parent_pager_attendant_history".');
			} else if (is_string($mixContent)) switch ($mixContent) {
				case 'Id': return QQN::ParentPagerAttendantHistory()->Id;
				case 'ServerIdentifier': return QQN::ParentPagerAttendantHistory()->ServerIdentifier;
				case 'ParentPagerIndividualId': return QQN::ParentPagerAttendantHistory()->ParentPagerIndividualId;
				case 'ParentPagerIndividual': return QQN::ParentPagerAttendantHistory()->ParentPagerIndividual;
				case 'ParentPagerStationId': return QQN::ParentPagerAttendantHistory()->ParentPagerStationId;
				case 'ParentPagerStation': return QQN::ParentPagerAttendantHistory()->ParentPagerStation;
				case 'ParentPagerPeriodId': return QQN::ParentPagerAttendantHistory()->ParentPagerPeriodId;
				case 'ParentPagerPeriod': return QQN::ParentPagerAttendantHistory()->ParentPagerPeriod;
				case 'ParentPagerProgramId': return QQN::ParentPagerAttendantHistory()->ParentPagerProgramId;
				case 'ParentPagerProgram': return QQN::ParentPagerAttendantHistory()->ParentPagerProgram;
				case 'DateIn': return QQN::ParentPagerAttendantHistory()->DateIn;
				case 'DateOut': return QQN::ParentPagerAttendantHistory()->DateOut;
				default: throw new QCallerException('Simple Property not found in ParentPagerAttendantHistoryDataGrid content: ' . $mixContent);
