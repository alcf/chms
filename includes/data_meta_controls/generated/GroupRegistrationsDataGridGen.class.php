<?php
	 ...
	 * listing a collection of GroupRegistrations objects.  It includes
	 ...
	 * 
	 */
	class GroupRegistrationsDataGridGen extends QDataGrid {
		/**
		 ...
		 * way of adding a column to this GroupRegistrations datagrid.  The description of a column's
		 * content can be either a text string description of a simple field name
		 * in the GroupRegistrations object, or it can be any QQNode extending from QQN::GroupRegistrations().
		 * 
		 ...
		 * sorting using two fields from the GroupRegistrations object.
		 *
		 ...
		 *
		 * @param mixed $mixContent string or QQNode from GroupRegistrations
		...
		public function MetaDataBinder(QQCondition $objCondition = null, $objOptionalClauses = null) {
			...
			if ($this->Paginator) $this->TotalItemCount = GroupRegistrations::QueryCount($objCondition, $objClauses);
		 ...
		 *
		 * Given a QQNode or a Text String, this will return a GroupRegistrations-based QQNode.
		 * It will also verify that it is a proper GroupRegistrations-based QQNode, and will throw an exception otherwise.
		 *
		...
		protected function ResolveContentItem($mixContent) {
			if ($mixContent instanceof QQNode) {
				...
				if ($mixContent->_RootTableName == 'group_registrations') {
					...
					throw new QCallerException('Content QQNode has a root table of "' . $mixContent->_RootTableName . '". Must be a root of "group_registrations".');
			} else if (is_string($mixContent)) switch ($mixContent) {
				case 'Id': return QQN::GroupRegistrations()->Id;
				case 'SourceListId': return QQN::GroupRegistrations()->SourceListId;
				case 'SourceList': return QQN::GroupRegistrations()->SourceList;
				case 'DateReceived': return QQN::GroupRegistrations()->DateReceived;
				case 'FirstName': return QQN::GroupRegistrations()->FirstName;
				case 'LastName': return QQN::GroupRegistrations()->LastName;
				case 'Gender': return QQN::GroupRegistrations()->Gender;
				case 'Address': return QQN::GroupRegistrations()->Address;
				case 'Phone': return QQN::GroupRegistrations()->Phone;
				case 'Email': return QQN::GroupRegistrations()->Email;
				case 'Comments': return QQN::GroupRegistrations()->Comments;
				case 'GroupRoleId': return QQN::GroupRegistrations()->GroupRoleId;
				case 'GroupRole': return QQN::GroupRegistrations()->GroupRole;
				case 'PreferredLocation1': return QQN::GroupRegistrations()->PreferredLocation1;
				case 'PreferredLocation2': return QQN::GroupRegistrations()->PreferredLocation2;
				case 'City': return QQN::GroupRegistrations()->City;
