<?php
	 ...
	 * listing a collection of StewardshipStack objects.  It includes
	 ...
	 * 
	 */
	class StewardshipStackDataGridGen extends QDataGrid {
		/**
		 ...
		 * way of adding a column to this StewardshipStack datagrid.  The description of a column's
		 * content can be either a text string description of a simple field name
		 * in the StewardshipStack object, or it can be any QQNode extending from QQN::StewardshipStack().
		 * 
		 ...
		 * sorting using two fields from the StewardshipStack object.
		 *
		 ...
		 *
		 * @param mixed $mixContent string or QQNode from StewardshipStack
		...
		public function MetaDataBinder(QQCondition $objCondition = null, $objOptionalClauses = null) {
			...
			if ($this->Paginator) $this->TotalItemCount = StewardshipStack::QueryCount($objCondition, $objClauses);
		 ...
		 *
		 * Given a QQNode or a Text String, this will return a StewardshipStack-based QQNode.
		 * It will also verify that it is a proper StewardshipStack-based QQNode, and will throw an exception otherwise.
		 *
		...
		protected function ResolveContentItem($mixContent) {
			if ($mixContent instanceof QQNode) {
				...
				if ($mixContent->_RootTableName == 'stewardship_stack') {
					...
					throw new QCallerException('Content QQNode has a root table of "' . $mixContent->_RootTableName . '". Must be a root of "stewardship_stack".');
			} else if (is_string($mixContent)) switch ($mixContent) {
				case 'Id': return QQN::StewardshipStack()->Id;
