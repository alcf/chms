<?php
	 ...
	 * listing a collection of ParentPagerProgram objects.  It includes
	 ...
	 * 
	 */
	class ParentPagerProgramDataGridGen extends QDataGrid {
		/**
		 ...
		 * way of adding a column to this ParentPagerProgram datagrid.  The description of a column's
		 * content can be either a text string description of a simple field name
		 * in the ParentPagerProgram object, or it can be any QQNode extending from QQN::ParentPagerProgram().
		 * 
		 ...
		 * sorting using two fields from the ParentPagerProgram object.
		 *
		 ...
		 *
		 * @param mixed $mixContent string or QQNode from ParentPagerProgram
		...
		public function MetaDataBinder(QQCondition $objCondition = null, $objOptionalClauses = null) {
			...
			if ($this->Paginator) $this->TotalItemCount = ParentPagerProgram::QueryCount($objCondition, $objClauses);
		 ...
		 *
		 * Given a QQNode or a Text String, this will return a ParentPagerProgram-based QQNode.
		 * It will also verify that it is a proper ParentPagerProgram-based QQNode, and will throw an exception otherwise.
		 *
		...
		protected function ResolveContentItem($mixContent) {
			if ($mixContent instanceof QQNode) {
				...
				if ($mixContent->_RootTableName == 'parent_pager_program') {
					...
					throw new QCallerException('Content QQNode has a root table of "' . $mixContent->_RootTableName . '". Must be a root of "parent_pager_program".');
			} else if (is_string($mixContent)) switch ($mixContent) {
				case 'Id': return QQN::ParentPagerProgram()->Id;
				case 'ServerIdentifier': return QQN::ParentPagerProgram()->ServerIdentifier;
				case 'Name': return QQN::ParentPagerProgram()->Name;
				case 'Description': return QQN::ParentPagerProgram()->Description;
				default: throw new QCallerException('Simple Property not found in ParentPagerProgramDataGrid content: ' . $mixContent);
