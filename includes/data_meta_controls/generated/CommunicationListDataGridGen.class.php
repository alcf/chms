<?php
	 ...
	 * listing a collection of CommunicationList objects.  It includes
	 ...
	 * 
	 */
	class CommunicationListDataGridGen extends QDataGrid {
		/**
		 ...
		 * way of adding a column to this CommunicationList datagrid.  The description of a column's
		 * content can be either a text string description of a simple field name
		 * in the CommunicationList object, or it can be any QQNode extending from QQN::CommunicationList().
		 * 
		 ...
		 * sorting using two fields from the CommunicationList object.
		 *
		 ...
		 *
		 * @param mixed $mixContent string or QQNode from CommunicationList
		...
		public function MetaDataBinder() {
			...
			if ($this->Paginator) {
				$this->TotalItemCount = CommunicationList::CountAll();
			}
			...
			$this->DataSource = CommunicationList::LoadAll($objClauses);
		}
		...
		protected function ResolveContentItem($mixContent) {
			if ($mixContent instanceof QQNode) {
				...
				case 'Id': return QQN::CommunicationList()->Id;
				case 'EmailBroadcastTypeId': return QQN::CommunicationList()->EmailBroadcastTypeId;
				case 'MinistryId': return QQN::CommunicationList()->MinistryId;
