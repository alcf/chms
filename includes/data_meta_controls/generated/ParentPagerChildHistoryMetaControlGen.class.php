<?php
	...
	class ParentPagerChildHistoryMetaControlGen extends QBaseClass {
		...
		public function txtId_Create($strControlId = null) {
			...
			$this->txtId->Text = $this->objParentPagerChildHistory->Id;
		...
		public function Refresh($blnReload = false) {
			...
			if ($this->txtId) $this->txtId->Text = $this->objParentPagerChildHistory->Id;
			if ($this->lblId) $this->lblId->Text = $this->objParentPagerChildHistory->Id;
		...
		public function SaveParentPagerChildHistory() {
			try {
				...
				if ($this->txtId) $this->objParentPagerChildHistory->Id = $this->txtId->Text;
