<?php
	 ...
	 * listing a collection of Encouragement objects.  It includes
	 ...
	 * 
	 */
	class EncouragementDataGridGen extends QDataGrid {
		/**
		 ...
		 * way of adding a column to this Encouragement datagrid.  The description of a column's
		 * content can be either a text string description of a simple field name
		 * in the Encouragement object, or it can be any QQNode extending from QQN::Encouragement().
		 * 
		 ...
		 * sorting using two fields from the Encouragement object.
		 *
		 ...
		 *
		 * @param mixed $mixContent string or QQNode from Encouragement
		...
		public function MetaDataBinder(QQCondition $objCondition = null, $objOptionalClauses = null) {
			...
			if ($this->Paginator) $this->TotalItemCount = Encouragement::QueryCount($objCondition, $objClauses);
			...
			// Set the DataSource to be a Query result from Encouragement, given the clauses above
			$this->DataSource = Encouragement::QueryArray($objCondition, $objClauses);
		}
		 ...
		 *
		 * Given a QQNode or a Text String, this will return a Encouragement-based QQNode.
		 * It will also verify that it is a proper Encouragement-based QQNode, and will throw an exception otherwise.
		 *
		...
		protected function ResolveContentItem($mixContent) {
			if ($mixContent instanceof QQNode) {
				...
				if ($mixContent->_RootTableName == 'encouragement') {
					...
					throw new QCallerException('Content QQNode has a root table of "' . $mixContent->_RootTableName . '". Must be a root of "encouragement".');
			} else if (is_string($mixContent)) switch ($mixContent) {
				case 'Id': return QQN::Encouragement()->Id;
				case 'PrayerId': return QQN::Encouragement()->PrayerId;
				case 'Content': return QQN::Encouragement()->Content;
				default: throw new QCallerException('Simple Property not found in EncouragementDataGrid content: ' . $mixContent);
