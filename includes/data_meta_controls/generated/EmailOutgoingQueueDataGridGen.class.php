<?php
	 ...
	 * listing a collection of EmailOutgoingQueue objects.  It includes
	 ...
	 * 
	 */
	class EmailOutgoingQueueDataGridGen extends QDataGrid {
		/**
		 ...
		 * way of adding a column to this EmailOutgoingQueue datagrid.  The description of a column's
		 * content can be either a text string description of a simple field name
		 * in the EmailOutgoingQueue object, or it can be any QQNode extending from QQN::EmailOutgoingQueue().
		 * 
		 ...
		 * sorting using two fields from the EmailOutgoingQueue object.
		 *
		 ...
		 *
		 * @param mixed $mixContent string or QQNode from EmailOutgoingQueue
		...
		public function MetaDataBinder(QQCondition $objCondition = null, $objOptionalClauses = null) {
			...
			if ($this->Paginator) $this->TotalItemCount = EmailOutgoingQueue::QueryCount($objCondition, $objClauses);
		 ...
		 *
		 * Given a QQNode or a Text String, this will return a EmailOutgoingQueue-based QQNode.
		 * It will also verify that it is a proper EmailOutgoingQueue-based QQNode, and will throw an exception otherwise.
		 *
		...
		protected function ResolveContentItem($mixContent) {
			if ($mixContent instanceof QQNode) {
				...
				if ($mixContent->_RootTableName == 'email_outgoing_queue') {
					...
					throw new QCallerException('Content QQNode has a root table of "' . $mixContent->_RootTableName . '". Must be a root of "email_outgoing_queue".');
