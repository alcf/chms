<?php
	 ...
	 * listing a collection of ClassAttendence objects.  It includes
	 ...
	 * 
	 */
	class ClassAttendenceDataGridGen extends QDataGrid {
		/**
		 ...
		 * way of adding a column to this ClassAttendence datagrid.  The description of a column's
		 * content can be either a text string description of a simple field name
		 * in the ClassAttendence object, or it can be any QQNode extending from QQN::ClassAttendence().
		 * 
		 ...
		 * sorting using two fields from the ClassAttendence object.
		 *
		 ...
		 *
		 * @param mixed $mixContent string or QQNode from ClassAttendence
		...
		public function MetaDataBinder(QQCondition $objCondition = null, $objOptionalClauses = null) {
			...
			if ($this->Paginator) $this->TotalItemCount = ClassAttendence::QueryCount($objCondition, $objClauses);
		 ...
		 *
		 * Given a QQNode or a Text String, this will return a ClassAttendence-based QQNode.
		 * It will also verify that it is a proper ClassAttendence-based QQNode, and will throw an exception otherwise.
		 *
		...
		protected function ResolveContentItem($mixContent) {
			if ($mixContent instanceof QQNode) {
				...
				if ($mixContent->_RootTableName == 'class_attendence') {
					...
					throw new QCallerException('Content QQNode has a root table of "' . $mixContent->_RootTableName . '". Must be a root of "class_attendence".');
			} else if (is_string($mixContent)) switch ($mixContent) {
				case 'Id': return QQN::ClassAttendence()->Id;
				case 'ClassRegistrationId': return QQN::ClassAttendence()->ClassRegistrationId;
				case 'ClassRegistration': return QQN::ClassAttendence()->ClassRegistration;
				case 'MeetingNumber': return QQN::ClassAttendence()->MeetingNumber;
				case 'PresentFlag': return QQN::ClassAttendence()->PresentFlag;
				default: throw new QCallerException('Simple Property not found in ClassAttendenceDataGrid content: ' . $mixContent);
