<?php
	 ...
	 * listing a collection of AttributeValue objects.  It includes
	 ...
	 * 
	 */
	class AttributeValueDataGridGen extends QDataGrid {
		/**
		 ...
		 * way of adding a column to this AttributeValue datagrid.  The description of a column's
		 * content can be either a text string description of a simple field name
		 * in the AttributeValue object, or it can be any QQNode extending from QQN::AttributeValue().
		 * 
		 ...
		 * sorting using two fields from the AttributeValue object.
		 *
		 ...
		 *
		 * @param mixed $mixContent string or QQNode from AttributeValue
		...
		public function MetaDataBinder() {
			...
			if ($this->Paginator) {
				$this->TotalItemCount = AttributeValue::CountAll();
			}
			...
			$this->DataSource = AttributeValue::LoadAll($objClauses);
		}
		...
		protected function ResolveContentItem($mixContent) {
			if ($mixContent instanceof QQNode) {
				...
				case 'Id': return QQN::AttributeValue()->Id;
				case 'AttributeId': return QQN::AttributeValue()->AttributeId;
				case 'Attribute': return QQN::AttributeValue()->Attribute;
