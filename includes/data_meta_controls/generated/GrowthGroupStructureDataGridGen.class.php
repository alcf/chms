<?php
	 ...
	 * listing a collection of GrowthGroupStructure objects.  It includes
	 ...
	 * 
	 */
	class GrowthGroupStructureDataGridGen extends QDataGrid {
		/**
		 ...
		 * way of adding a column to this GrowthGroupStructure datagrid.  The description of a column's
		 * content can be either a text string description of a simple field name
		 * in the GrowthGroupStructure object, or it can be any QQNode extending from QQN::GrowthGroupStructure().
		 * 
		 ...
		 * sorting using two fields from the GrowthGroupStructure object.
		 *
		 ...
		 *
		 * @param mixed $mixContent string or QQNode from GrowthGroupStructure
		...
		public function MetaDataBinder() {
			...
			if ($this->Paginator) {
				$this->TotalItemCount = GrowthGroupStructure::CountAll();
			}
			...
			$this->DataSource = GrowthGroupStructure::LoadAll($objClauses);
		}
		 ...
		 *
		 * Given a QQNode or a Text String, this will return a GrowthGroupStructure-based QQNode.
		 * It will also verify that it is a proper GrowthGroupStructure-based QQNode, and will throw an exception otherwise.
		 *
		...
		protected function ResolveContentItem($mixContent) {
			if ($mixContent instanceof QQNode) {
				...
				if ($mixContent->_RootTableName == 'growth_group_structure') {
					...
					throw new QCallerException('Content QQNode has a root table of "' . $mixContent->_RootTableName . '". Must be a root of "growth_group_structure".');
			} else if (is_string($mixContent)) switch ($mixContent) {
				case 'Id': return QQN::GrowthGroupStructure()->Id;
				case 'Name': return QQN::GrowthGroupStructure()->Name;
				default: throw new QCallerException('Simple Property not found in GrowthGroupStructureDataGrid content: ' . $mixContent);
