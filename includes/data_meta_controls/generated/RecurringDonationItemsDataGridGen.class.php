<?php
	 ...
	 * listing a collection of RecurringDonationItems objects.  It includes
	 ...
	 * 
	 */
	class RecurringDonationItemsDataGridGen extends QDataGrid {
		/**
		 ...
		 * way of adding a column to this RecurringDonationItems datagrid.  The description of a column's
		 * content can be either a text string description of a simple field name
		 * in the RecurringDonationItems object, or it can be any QQNode extending from QQN::RecurringDonationItems().
		 * 
		 ...
		 * sorting using two fields from the RecurringDonationItems object.
		 *
		 ...
		 *
		 * @param mixed $mixContent string or QQNode from RecurringDonationItems
		...
		public function MetaDataBinder(QQCondition $objCondition = null, $objOptionalClauses = null) {
			...
			if ($this->Paginator) $this->TotalItemCount = RecurringDonationItems::QueryCount($objCondition, $objClauses);
		 ...
		 *
		 * Given a QQNode or a Text String, this will return a RecurringDonationItems-based QQNode.
		 * It will also verify that it is a proper RecurringDonationItems-based QQNode, and will throw an exception otherwise.
		 *
		...
		protected function ResolveContentItem($mixContent) {
			if ($mixContent instanceof QQNode) {
				...
				if ($mixContent->_RootTableName == 'recurring_donation_items') {
					...
					throw new QCallerException('Content QQNode has a root table of "' . $mixContent->_RootTableName . '". Must be a root of "recurring_donation_items".');
			} else if (is_string($mixContent)) switch ($mixContent) {
				case 'Id': return QQN::RecurringDonationItems()->Id;
				case 'RecurringDonationId': return QQN::RecurringDonationItems()->RecurringDonationId;
				case 'RecurringDonation': return QQN::RecurringDonationItems()->RecurringDonation;
				case 'Amount': return QQN::RecurringDonationItems()->Amount;
				case 'DonationFlag': return QQN::RecurringDonationItems()->DonationFlag;
				case 'StewardshipFundId': return QQN::RecurringDonationItems()->StewardshipFundId;
				case 'StewardshipFund': return QQN::RecurringDonationItems()->StewardshipFund;
				case 'Other': return QQN::RecurringDonationItems()->Other;
				default: throw new QCallerException('Simple Property not found in RecurringDonationItemsDataGrid content: ' . $mixContent);
