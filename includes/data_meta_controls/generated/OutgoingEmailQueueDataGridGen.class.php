<?php
	 ...
	 * listing a collection of OutgoingEmailQueue objects.  It includes
	 ...
	 * 
	 */
	class OutgoingEmailQueueDataGridGen extends QDataGrid {
		/**
		 ...
		 * way of adding a column to this OutgoingEmailQueue datagrid.  The description of a column's
		 * content can be either a text string description of a simple field name
		 * in the OutgoingEmailQueue object, or it can be any QQNode extending from QQN::OutgoingEmailQueue().
		 * 
		 ...
		 * sorting using two fields from the OutgoingEmailQueue object.
		 *
		 ...
		 *
		 * @param mixed $mixContent string or QQNode from OutgoingEmailQueue
		...
		public function MetaDataBinder(QQCondition $objCondition = null, $objOptionalClauses = null) {
			...
			if ($this->Paginator) $this->TotalItemCount = OutgoingEmailQueue::QueryCount($objCondition, $objClauses);
		 ...
		 *
		 * Given a QQNode or a Text String, this will return a OutgoingEmailQueue-based QQNode.
		 * It will also verify that it is a proper OutgoingEmailQueue-based QQNode, and will throw an exception otherwise.
		 *
		...
		protected function ResolveContentItem($mixContent) {
			if ($mixContent instanceof QQNode) {
				...
				if ($mixContent->_RootTableName == 'outgoing_email_queue') {
					...
					throw new QCallerException('Content QQNode has a root table of "' . $mixContent->_RootTableName . '". Must be a root of "outgoing_email_queue".');
				...
				case 'ErrorFlag': return QQN::OutgoingEmailQueue()->ErrorFlag;
				case 'ErrorMessage': return QQN::OutgoingEmailQueue()->ErrorMessage;
				default: throw new QCallerException('Simple Property not found in OutgoingEmailQueueDataGrid content: ' . $mixContent);
