<?php
	 ...
	 * listing a collection of SmsMessage objects.  It includes
	 ...
	 * 
	 */
	class SmsMessageDataGridGen extends QDataGrid {
		/**
		 ...
		 * way of adding a column to this SmsMessage datagrid.  The description of a column's
		 * content can be either a text string description of a simple field name
		 * in the SmsMessage object, or it can be any QQNode extending from QQN::SmsMessage().
		 * 
		 ...
		 * sorting using two fields from the SmsMessage object.
		 *
		 ...
		 *
		 * @param mixed $mixContent string or QQNode from SmsMessage
		...
		public function MetaDataBinder(QQCondition $objCondition = null, $objOptionalClauses = null) {
			...
			if ($this->Paginator) $this->TotalItemCount = SmsMessage::QueryCount($objCondition, $objClauses);
		 ...
		 *
		 * Given a QQNode or a Text String, this will return a SmsMessage-based QQNode.
		 * It will also verify that it is a proper SmsMessage-based QQNode, and will throw an exception otherwise.
		 *
		...
		protected function ResolveContentItem($mixContent) {
			if ($mixContent instanceof QQNode) {
				...
				if ($mixContent->_RootTableName == 'sms_message') {
					...
					throw new QCallerException('Content QQNode has a root table of "' . $mixContent->_RootTableName . '". Must be a root of "sms_message".');
			} else if (is_string($mixContent)) switch ($mixContent) {
				case 'Id': return QQN::SmsMessage()->Id;
				case 'GroupId': return QQN::SmsMessage()->GroupId;
				case 'Group': return QQN::SmsMessage()->Group;
				case 'LoginId': return QQN::SmsMessage()->LoginId;
				case 'Login': return QQN::SmsMessage()->Login;
				case 'Subject': return QQN::SmsMessage()->Subject;
				case 'Body': return QQN::SmsMessage()->Body;
				case 'DateQueued': return QQN::SmsMessage()->DateQueued;
				case 'DateSent': return QQN::SmsMessage()->DateSent;
				default: throw new QCallerException('Simple Property not found in SmsMessageDataGrid content: ' . $mixContent);
