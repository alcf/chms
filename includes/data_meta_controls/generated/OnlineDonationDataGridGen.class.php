<?php
	 ...
	 * listing a collection of OnlineDonation objects.  It includes
	 ...
	 * 
	 */
	class OnlineDonationDataGridGen extends QDataGrid {
		/**
		 ...
		 * way of adding a column to this OnlineDonation datagrid.  The description of a column's
		 * content can be either a text string description of a simple field name
		 * in the OnlineDonation object, or it can be any QQNode extending from QQN::OnlineDonation().
		 * 
		 ...
		 * sorting using two fields from the OnlineDonation object.
		 *
		 ...
		 *
		 * @param mixed $mixContent string or QQNode from OnlineDonation
		...
		public function MetaDataBinder(QQCondition $objCondition = null, $objOptionalClauses = null) {
			...
			if ($this->Paginator) $this->TotalItemCount = OnlineDonation::QueryCount($objCondition, $objClauses);
		 ...
		 *
		 * Given a QQNode or a Text String, this will return a OnlineDonation-based QQNode.
		 * It will also verify that it is a proper OnlineDonation-based QQNode, and will throw an exception otherwise.
		 *
		...
		protected function ResolveContentItem($mixContent) {
			if ($mixContent instanceof QQNode) {
				...
				if ($mixContent->_RootTableName == 'online_donation') {
					...
					throw new QCallerException('Content QQNode has a root table of "' . $mixContent->_RootTableName . '". Must be a root of "online_donation".');
