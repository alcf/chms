<?php
	 ...
	 * listing a collection of CheckingAccountLookup objects.  It includes
	 ...
	 * 
	 */
	class CheckingAccountLookupDataGridGen extends QDataGrid {
		/**
		 ...
		 * way of adding a column to this CheckingAccountLookup datagrid.  The description of a column's
		 * content can be either a text string description of a simple field name
		 * in the CheckingAccountLookup object, or it can be any QQNode extending from QQN::CheckingAccountLookup().
		 * 
		 ...
		 * sorting using two fields from the CheckingAccountLookup object.
		 *
		 ...
		 *
		 * @param mixed $mixContent string or QQNode from CheckingAccountLookup
		...
		public function MetaDataBinder(QQCondition $objCondition = null, $objOptionalClauses = null) {
			...
			if ($this->Paginator) $this->TotalItemCount = CheckingAccountLookup::QueryCount($objCondition, $objClauses);
		 ...
		 *
		 * Given a QQNode or a Text String, this will return a CheckingAccountLookup-based QQNode.
		 * It will also verify that it is a proper CheckingAccountLookup-based QQNode, and will throw an exception otherwise.
		 *
		...
		protected function ResolveContentItem($mixContent) {
			if ($mixContent instanceof QQNode) {
				...
				if ($mixContent->_RootTableName == 'checking_account_lookup') {
