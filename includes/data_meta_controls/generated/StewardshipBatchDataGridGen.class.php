<?php
	 ...
	 * listing a collection of StewardshipBatch objects.  It includes
	 ...
	 * 
	 */
	class StewardshipBatchDataGridGen extends QDataGrid {
		/**
		 ...
		 * way of adding a column to this StewardshipBatch datagrid.  The description of a column's
		 * content can be either a text string description of a simple field name
		 * in the StewardshipBatch object, or it can be any QQNode extending from QQN::StewardshipBatch().
		 * 
		 ...
		 * sorting using two fields from the StewardshipBatch object.
		 *
		 ...
		 *
		 * @param mixed $mixContent string or QQNode from StewardshipBatch
		...
		public function MetaDataBinder(QQCondition $objCondition = null, $objOptionalClauses = null) {
			...
			if ($this->Paginator) $this->TotalItemCount = StewardshipBatch::QueryCount($objCondition, $objClauses);
			...
			// Set the DataSource to be a Query result from StewardshipBatch, given the clauses above
			$this->DataSource = StewardshipBatch::QueryArray($objCondition, $objClauses);
		}
		 ...
		 *
		 * Given a QQNode or a Text String, this will return a StewardshipBatch-based QQNode.
		 * It will also verify that it is a proper StewardshipBatch-based QQNode, and will throw an exception otherwise.
		 *
		...
		protected function ResolveContentItem($mixContent) {
			if ($mixContent instanceof QQNode) {
				...
				if ($mixContent->_RootTableName == 'stewardship_batch') {
