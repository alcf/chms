<?php
	 ...
	 * listing a collection of Ministry objects.  It includes
	 ...
	 * 
	 */
	class MinistryDataGridGen extends QDataGrid {
		/**
		 ...
		 * way of adding a column to this Ministry datagrid.  The description of a column's
		 * content can be either a text string description of a simple field name
		 * in the Ministry object, or it can be any QQNode extending from QQN::Ministry().
		 * 
		 ...
		 * sorting using two fields from the Ministry object.
		 *
		 ...
		 *
		 * @param mixed $mixContent string or QQNode from Ministry
		...
		public function MetaDataBinder(QQCondition $objCondition = null, $objOptionalClauses = null) {
			...
			if ($this->Paginator) $this->TotalItemCount = Ministry::QueryCount($objCondition, $objClauses);
			...
			// Set the DataSource to be a Query result from Ministry, given the clauses above
			$this->DataSource = Ministry::QueryArray($objCondition, $objClauses);
		}
		...
		protected function ResolveContentItem($mixContent) {
			if ($mixContent instanceof QQNode) {
				...
				case 'Id': return QQN::Ministry()->Id;
				case 'Token': return QQN::Ministry()->Token;
				case 'Name': return QQN::Ministry()->Name;
