<?php
	 ...
	 * listing a collection of RecurringPayments objects.  It includes
	 ...
	 * 
	 */
	class RecurringPaymentsDataGridGen extends QDataGrid {
		/**
		 ...
		 * way of adding a column to this RecurringPayments datagrid.  The description of a column's
		 * content can be either a text string description of a simple field name
		 * in the RecurringPayments object, or it can be any QQNode extending from QQN::RecurringPayments().
		 * 
		 ...
		 * sorting using two fields from the RecurringPayments object.
		 *
		 ...
		 *
		 * @param mixed $mixContent string or QQNode from RecurringPayments
		...
		public function MetaDataBinder(QQCondition $objCondition = null, $objOptionalClauses = null) {
			...
			if ($this->Paginator) $this->TotalItemCount = RecurringPayments::QueryCount($objCondition, $objClauses);
		 ...
		 *
		 * Given a QQNode or a Text String, this will return a RecurringPayments-based QQNode.
		 * It will also verify that it is a proper RecurringPayments-based QQNode, and will throw an exception otherwise.
		 *
		...
		protected function ResolveContentItem($mixContent) {
			if ($mixContent instanceof QQNode) {
				...
				if ($mixContent->_RootTableName == 'recurring_payments') {
					...
					throw new QCallerException('Content QQNode has a root table of "' . $mixContent->_RootTableName . '". Must be a root of "recurring_payments".');
			} else if (is_string($mixContent)) switch ($mixContent) {
				case 'Id': return QQN::RecurringPayments()->Id;
				case 'Name': return QQN::RecurringPayments()->Name;
				case 'PaymentPeriodId': return QQN::RecurringPayments()->PaymentPeriodId;
				case 'PaymentPeriod': return QQN::RecurringPayments()->PaymentPeriod;
				case 'Amount': return QQN::RecurringPayments()->Amount;
				case 'StartDate': return QQN::RecurringPayments()->StartDate;
				case 'EndDate': return QQN::RecurringPayments()->EndDate;
				case 'AuthorizeFlag': return QQN::RecurringPayments()->AuthorizeFlag;
				case 'CardHolderName': return QQN::RecurringPayments()->CardHolderName;
				case 'Address1': return QQN::RecurringPayments()->Address1;
				case 'Address2': return QQN::RecurringPayments()->Address2;
				case 'City': return QQN::RecurringPayments()->City;
				case 'State': return QQN::RecurringPayments()->State;
				case 'Zip': return QQN::RecurringPayments()->Zip;
				case 'CreditCardTypeId': return QQN::RecurringPayments()->CreditCardTypeId;
				case 'AccountNumber': return QQN::RecurringPayments()->AccountNumber;
				case 'ExpirationDate': return QQN::RecurringPayments()->ExpirationDate;
				case 'SecurityCode': return QQN::RecurringPayments()->SecurityCode;
				case 'RecurringDonationAsRecurringPayment': return QQN::RecurringPayments()->RecurringDonationAsRecurringPayment;

				default: throw new QCallerException('Simple Property not found in RecurringPaymentsDataGrid content: ' . $mixContent);
