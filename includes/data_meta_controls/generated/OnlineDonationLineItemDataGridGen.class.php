<?php
	 ...
	 * listing a collection of OnlineDonationLineItem objects.  It includes
	 ...
	 * 
	 */
	class OnlineDonationLineItemDataGridGen extends QDataGrid {
		/**
		 ...
		 * way of adding a column to this OnlineDonationLineItem datagrid.  The description of a column's
		 * content can be either a text string description of a simple field name
		 * in the OnlineDonationLineItem object, or it can be any QQNode extending from QQN::OnlineDonationLineItem().
		 * 
		 ...
		 * sorting using two fields from the OnlineDonationLineItem object.
		 *
		 ...
		 *
		 * @param mixed $mixContent string or QQNode from OnlineDonationLineItem
		...
		public function MetaDataBinder(QQCondition $objCondition = null, $objOptionalClauses = null) {
			...
			if ($this->Paginator) $this->TotalItemCount = OnlineDonationLineItem::QueryCount($objCondition, $objClauses);
		 ...
		 *
		 * Given a QQNode or a Text String, this will return a OnlineDonationLineItem-based QQNode.
		 * It will also verify that it is a proper OnlineDonationLineItem-based QQNode, and will throw an exception otherwise.
		 *
		...
		protected function ResolveContentItem($mixContent) {
			if ($mixContent instanceof QQNode) {
				...
				if ($mixContent->_RootTableName == 'online_donation_line_item') {
					...
					throw new QCallerException('Content QQNode has a root table of "' . $mixContent->_RootTableName . '". Must be a root of "online_donation_line_item".');
			} else if (is_string($mixContent)) switch ($mixContent) {
				case 'Id': return QQN::OnlineDonationLineItem()->Id;
				...
				default: throw new QCallerException('Simple Property not found in OnlineDonationLineItemDataGrid content: ' . $mixContent);
