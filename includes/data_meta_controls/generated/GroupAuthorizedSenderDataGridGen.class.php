<?php
	 ...
	 * listing a collection of GroupAuthorizedSender objects.  It includes
	 ...
	 * 
	 */
	class GroupAuthorizedSenderDataGridGen extends QDataGrid {
		/**
		 ...
		 * way of adding a column to this GroupAuthorizedSender datagrid.  The description of a column's
		 * content can be either a text string description of a simple field name
		 * in the GroupAuthorizedSender object, or it can be any QQNode extending from QQN::GroupAuthorizedSender().
		 * 
		 ...
		 * sorting using two fields from the GroupAuthorizedSender object.
		 *
		 ...
		 *
		 * @param mixed $mixContent string or QQNode from GroupAuthorizedSender
		...
		public function MetaDataBinder(QQCondition $objCondition = null, $objOptionalClauses = null) {
			...
			if ($this->Paginator) $this->TotalItemCount = GroupAuthorizedSender::QueryCount($objCondition, $objClauses);
		 ...
		 *
		 * Given a QQNode or a Text String, this will return a GroupAuthorizedSender-based QQNode.
		 * It will also verify that it is a proper GroupAuthorizedSender-based QQNode, and will throw an exception otherwise.
		 *
		...
		protected function ResolveContentItem($mixContent) {
			if ($mixContent instanceof QQNode) {
				...
				if ($mixContent->_RootTableName == 'group_authorized_sender') {
					...
					throw new QCallerException('Content QQNode has a root table of "' . $mixContent->_RootTableName . '". Must be a root of "group_authorized_sender".');
			} else if (is_string($mixContent)) switch ($mixContent) {
				case 'Id': return QQN::GroupAuthorizedSender()->Id;
				case 'GroupId': return QQN::GroupAuthorizedSender()->GroupId;
				case 'Group': return QQN::GroupAuthorizedSender()->Group;
				case 'PersonId': return QQN::GroupAuthorizedSender()->PersonId;
				case 'Person': return QQN::GroupAuthorizedSender()->Person;
				default: throw new QCallerException('Simple Property not found in GroupAuthorizedSenderDataGrid content: ' . $mixContent);
