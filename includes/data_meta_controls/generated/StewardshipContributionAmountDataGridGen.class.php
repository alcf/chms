<?php
	 ...
	 * listing a collection of StewardshipContributionAmount objects.  It includes
	 ...
	 * 
	 */
	class StewardshipContributionAmountDataGridGen extends QDataGrid {
		/**
		 ...
		 * way of adding a column to this StewardshipContributionAmount datagrid.  The description of a column's
		 * content can be either a text string description of a simple field name
		 * in the StewardshipContributionAmount object, or it can be any QQNode extending from QQN::StewardshipContributionAmount().
		 * 
		 ...
		 * sorting using two fields from the StewardshipContributionAmount object.
		 *
		 ...
		 *
		 * @param mixed $mixContent string or QQNode from StewardshipContributionAmount
		...
		public function MetaDataBinder(QQCondition $objCondition = null, $objOptionalClauses = null) {
			...
			if ($this->Paginator) $this->TotalItemCount = StewardshipContributionAmount::QueryCount($objCondition, $objClauses);
		...
		protected function ResolveContentItem($mixContent) {
			if ($mixContent instanceof QQNode) {
				...
				case 'Id': return QQN::StewardshipContributionAmount()->Id;
				case 'StewardshipContributionId': return QQN::StewardshipContributionAmount()->StewardshipContributionId;
				case 'StewardshipContribution': return QQN::StewardshipContributionAmount()->StewardshipContribution;
				case 'StewardshipFundId': return QQN::StewardshipContributionAmount()->StewardshipFundId;
				case 'StewardshipFund': return QQN::StewardshipContributionAmount()->StewardshipFund;
				case 'Amount': return QQN::StewardshipContributionAmount()->Amount;
				default: throw new QCallerException('Simple Property not found in StewardshipContributionAmountDataGrid content: ' . $mixContent);
