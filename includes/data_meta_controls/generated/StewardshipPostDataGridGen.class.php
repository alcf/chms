<?php
	 ...
	 * listing a collection of StewardshipPost objects.  It includes
	 ...
	 * 
	 */
	class StewardshipPostDataGridGen extends QDataGrid {
		/**
		 ...
		 * way of adding a column to this StewardshipPost datagrid.  The description of a column's
		 * content can be either a text string description of a simple field name
		 * in the StewardshipPost object, or it can be any QQNode extending from QQN::StewardshipPost().
		 * 
		 ...
		 * sorting using two fields from the StewardshipPost object.
		 *
		 ...
		 *
		 * @param mixed $mixContent string or QQNode from StewardshipPost
		...
		public function MetaDataBinder(QQCondition $objCondition = null, $objOptionalClauses = null) {
			...
			if ($this->Paginator) $this->TotalItemCount = StewardshipPost::QueryCount($objCondition, $objClauses);
		 ...
		 *
		 * Given a QQNode or a Text String, this will return a StewardshipPost-based QQNode.
		 * It will also verify that it is a proper StewardshipPost-based QQNode, and will throw an exception otherwise.
		 *
		...
		protected function ResolveContentItem($mixContent) {
			if ($mixContent instanceof QQNode) {
				...
				if ($mixContent->_RootTableName == 'stewardship_post') {
					...
					throw new QCallerException('Content QQNode has a root table of "' . $mixContent->_RootTableName . '". Must be a root of "stewardship_post".');
			} else if (is_string($mixContent)) switch ($mixContent) {
				case 'Id': return QQN::StewardshipPost()->Id;
				case 'StewardshipBatchId': return QQN::StewardshipPost()->StewardshipBatchId;
				case 'StewardshipBatch': return QQN::StewardshipPost()->StewardshipBatch;
