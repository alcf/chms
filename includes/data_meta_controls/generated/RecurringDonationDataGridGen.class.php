<?php
	 ...
	 * listing a collection of RecurringDonation objects.  It includes
	 ...
	 * 
	 */
	class RecurringDonationDataGridGen extends QDataGrid {
		/**
		 ...
		 * way of adding a column to this RecurringDonation datagrid.  The description of a column's
		 * content can be either a text string description of a simple field name
		 * in the RecurringDonation object, or it can be any QQNode extending from QQN::RecurringDonation().
		 * 
		 ...
		 * sorting using two fields from the RecurringDonation object.
		 *
		 ...
		 *
		 * @param mixed $mixContent string or QQNode from RecurringDonation
		...
		public function MetaDataBinder(QQCondition $objCondition = null, $objOptionalClauses = null) {
			...
			if ($this->Paginator) $this->TotalItemCount = RecurringDonation::QueryCount($objCondition, $objClauses);
		 ...
		 *
		 * Given a QQNode or a Text String, this will return a RecurringDonation-based QQNode.
		 * It will also verify that it is a proper RecurringDonation-based QQNode, and will throw an exception otherwise.
		 *
		...
		protected function ResolveContentItem($mixContent) {
			if ($mixContent instanceof QQNode) {
				...
				if ($mixContent->_RootTableName == 'recurring_donation') {
					...
					throw new QCallerException('Content QQNode has a root table of "' . $mixContent->_RootTableName . '". Must be a root of "recurring_donation".');
			} else if (is_string($mixContent)) switch ($mixContent) {
				case 'Id': return QQN::RecurringDonation()->Id;
				case 'PersonId': return QQN::RecurringDonation()->PersonId;
				case 'RecurringPaymentId': return QQN::RecurringDonation()->RecurringPaymentId;
				case 'RecurringPayment': return QQN::RecurringDonation()->RecurringPayment;
				case 'Amount': return QQN::RecurringDonation()->Amount;
				case 'ConfirmationEmail': return QQN::RecurringDonation()->ConfirmationEmail;
				default: throw new QCallerException('Simple Property not found in RecurringDonationDataGrid content: ' . $mixContent);
