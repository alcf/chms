<?php
	 ...
	 * listing a collection of AvailabilityStatus objects.  It includes
	 ...
	 * 
	 */
	class AvailabilityStatusDataGridGen extends QDataGrid {
		/**
		 ...
		 * way of adding a column to this AvailabilityStatus datagrid.  The description of a column's
		 * content can be either a text string description of a simple field name
		 * in the AvailabilityStatus object, or it can be any QQNode extending from QQN::AvailabilityStatus().
		 * 
		 ...
		 * sorting using two fields from the AvailabilityStatus object.
		 *
		 ...
		 *
		 * @param mixed $mixContent string or QQNode from AvailabilityStatus
		...
		public function MetaDataBinder(QQCondition $objCondition = null, $objOptionalClauses = null) {
			...
			if ($this->Paginator) $this->TotalItemCount = AvailabilityStatus::QueryCount($objCondition, $objClauses);
		 ...
		 *
		 * Given a QQNode or a Text String, this will return a AvailabilityStatus-based QQNode.
		 * It will also verify that it is a proper AvailabilityStatus-based QQNode, and will throw an exception otherwise.
		 *
		...
		protected function ResolveContentItem($mixContent) {
			if ($mixContent instanceof QQNode) {
				...
				if ($mixContent->_RootTableName == 'availability_status') {
					...
					throw new QCallerException('Content QQNode has a root table of "' . $mixContent->_RootTableName . '". Must be a root of "availability_status".');
			} else if (is_string($mixContent)) switch ($mixContent) {
				case 'Id': return QQN::AvailabilityStatus()->Id;
				case 'Name': return QQN::AvailabilityStatus()->Name;
				default: throw new QCallerException('Simple Property not found in AvailabilityStatusDataGrid content: ' . $mixContent);
