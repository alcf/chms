<?php
	 ...
	 * listing a collection of StewardshipFund objects.  It includes
	 ...
	 * 
	 */
	class StewardshipFundDataGridGen extends QDataGrid {
		/**
		 ...
		 * way of adding a column to this StewardshipFund datagrid.  The description of a column's
		 * content can be either a text string description of a simple field name
		 * in the StewardshipFund object, or it can be any QQNode extending from QQN::StewardshipFund().
		 * 
		 ...
		 * sorting using two fields from the StewardshipFund object.
		 *
		 ...
		 *
		 * @param mixed $mixContent string or QQNode from StewardshipFund
		...
		public function MetaDataBinder(QQCondition $objCondition = null, $objOptionalClauses = null) {
			...
			if ($this->Paginator) $this->TotalItemCount = StewardshipFund::QueryCount($objCondition, $objClauses);
			...
			// Set the DataSource to be a Query result from StewardshipFund, given the clauses above
			$this->DataSource = StewardshipFund::QueryArray($objCondition, $objClauses);
		}
		...
		protected function ResolveContentItem($mixContent) {
			if ($mixContent instanceof QQNode) {
				...
				case 'Id': return QQN::StewardshipFund()->Id;
				case 'MinistryId': return QQN::StewardshipFund()->MinistryId;
				case 'Ministry': return QQN::StewardshipFund()->Ministry;
				case 'Name': return QQN::StewardshipFund()->Name;
				case 'ExternalName': return QQN::StewardshipFund()->ExternalName;
				case 'AccountNumber': return QQN::StewardshipFund()->AccountNumber;
				case 'FundNumber': return QQN::StewardshipFund()->FundNumber;
				case 'ActiveFlag': return QQN::StewardshipFund()->ActiveFlag;
				case 'ExternalFlag': return QQN::StewardshipFund()->ExternalFlag;
