<?php
	 ...
	 * listing a collection of ParentPagerIndividual objects.  It includes
	 ...
	 * 
	 */
	class ParentPagerIndividualDataGridGen extends QDataGrid {
		/**
		 ...
		 * way of adding a column to this ParentPagerIndividual datagrid.  The description of a column's
		 * content can be either a text string description of a simple field name
		 * in the ParentPagerIndividual object, or it can be any QQNode extending from QQN::ParentPagerIndividual().
		 * 
		 ...
		 * sorting using two fields from the ParentPagerIndividual object.
		 *
		 ...
		 *
		 * @param mixed $mixContent string or QQNode from ParentPagerIndividual
		...
		public function MetaDataBinder(QQCondition $objCondition = null, $objOptionalClauses = null) {
			...
			if ($this->Paginator) $this->TotalItemCount = ParentPagerIndividual::QueryCount($objCondition, $objClauses);
		...
		protected function ResolveContentItem($mixContent) {
			if ($mixContent instanceof QQNode) {
				...
				case 'Id': return QQN::ParentPagerIndividual()->Id;
				case 'ServerIdentifier': return QQN::ParentPagerIndividual()->ServerIdentifier;
				case 'PersonId': return QQN::ParentPagerIndividual()->PersonId;
				case 'Person': return QQN::ParentPagerIndividual()->Person;
				case 'HiddenFlag': return QQN::ParentPagerIndividual()->HiddenFlag;
				case 'ParentPagerSyncStatusTypeId': return QQN::ParentPagerIndividual()->ParentPagerSyncStatusTypeId;
				case 'ParentPagerHouseholdId': return QQN::ParentPagerIndividual()->ParentPagerHouseholdId;
				case 'ParentPagerHousehold': return QQN::ParentPagerIndividual()->ParentPagerHousehold;
				case 'FirstName': return QQN::ParentPagerIndividual()->FirstName;
				case 'MiddleName': return QQN::ParentPagerIndividual()->MiddleName;
				case 'LastName': return QQN::ParentPagerIndividual()->LastName;
				case 'Prefix': return QQN::ParentPagerIndividual()->Prefix;
				case 'Suffix': return QQN::ParentPagerIndividual()->Suffix;
				case 'Nickname': return QQN::ParentPagerIndividual()->Nickname;
				case 'GraduationYear': return QQN::ParentPagerIndividual()->GraduationYear;
				case 'Gender': return QQN::ParentPagerIndividual()->Gender;
				case 'DateOfBirth': return QQN::ParentPagerIndividual()->DateOfBirth;
				default: throw new QCallerException('Simple Property not found in ParentPagerIndividualDataGrid content: ' . $mixContent);
