<?php
	 ...
	 * listing a collection of Group objects.  It includes
	 ...
	 * 
	 */
	class GroupDataGridGen extends QDataGrid {
		/**
		 ...
		 * way of adding a column to this Group datagrid.  The description of a column's
		 * content can be either a text string description of a simple field name
		 * in the Group object, or it can be any QQNode extending from QQN::Group().
		 * 
		 ...
		 * sorting using two fields from the Group object.
		 *
		 ...
		 *
		 * @param mixed $mixContent string or QQNode from Group
		...
		public function MetaDataBinder(QQCondition $objCondition = null, $objOptionalClauses = null) {
			...
			if ($this->Paginator) $this->TotalItemCount = Group::QueryCount($objCondition, $objClauses);
			...
			// Set the DataSource to be a Query result from Group, given the clauses above
			$this->DataSource = Group::QueryArray($objCondition, $objClauses);
		}
		...
		protected function ResolveContentItem($mixContent) {
			if ($mixContent instanceof QQNode) {
				...
				case 'Id': return QQN::Group()->Id;
				case 'GroupTypeId': return QQN::Group()->GroupTypeId;
				...
				default: throw new QCallerException('Simple Property not found in GroupDataGrid content: ' . $mixContent);
