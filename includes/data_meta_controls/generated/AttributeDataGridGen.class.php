<?php
	 ...
	 * listing a collection of Attribute objects.  It includes
	 ...
	 * 
	 */
	class AttributeDataGridGen extends QDataGrid {
		/**
		 ...
		 * way of adding a column to this Attribute datagrid.  The description of a column's
		 * content can be either a text string description of a simple field name
		 * in the Attribute object, or it can be any QQNode extending from QQN::Attribute().
		 * 
		 ...
		 * sorting using two fields from the Attribute object.
		 *
		 ...
		 *
		 * @param mixed $mixContent string or QQNode from Attribute
		...
		public function MetaDataBinder(QQCondition $objCondition = null, $objOptionalClauses = null) {
			...
			if ($this->Paginator) $this->TotalItemCount = Attribute::QueryCount($objCondition, $objClauses);
			...
			// Set the DataSource to be a Query result from Attribute, given the clauses above
			$this->DataSource = Attribute::QueryArray($objCondition, $objClauses);
		}
		...
		protected function ResolveContentItem($mixContent) {
			if ($mixContent instanceof QQNode) {
				...
				case 'Id': return QQN::Attribute()->Id;
				case 'AttributeDataTypeId': return QQN::Attribute()->AttributeDataTypeId;
				case 'Name': return QQN::Attribute()->Name;
				default: throw new QCallerException('Simple Property not found in AttributeDataGrid content: ' . $mixContent);
