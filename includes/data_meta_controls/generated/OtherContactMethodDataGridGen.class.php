<?php
	 ...
	 * listing a collection of OtherContactMethod objects.  It includes
	 ...
	 * 
	 */
	class OtherContactMethodDataGridGen extends QDataGrid {
		/**
		 ...
		 * way of adding a column to this OtherContactMethod datagrid.  The description of a column's
		 * content can be either a text string description of a simple field name
		 * in the OtherContactMethod object, or it can be any QQNode extending from QQN::OtherContactMethod().
		 * 
		 ...
		 * sorting using two fields from the OtherContactMethod object.
		 *
		 ...
		 *
		 * @param mixed $mixContent string or QQNode from OtherContactMethod
		...
		public function MetaDataBinder() {
			...
			if ($this->Paginator) {
				$this->TotalItemCount = OtherContactMethod::CountAll();
			}
			...
			$this->DataSource = OtherContactMethod::LoadAll($objClauses);
		}
		 ...
		 *
		 * Given a QQNode or a Text String, this will return a OtherContactMethod-based QQNode.
		 * It will also verify that it is a proper OtherContactMethod-based QQNode, and will throw an exception otherwise.
		 *
		...
		protected function ResolveContentItem($mixContent) {
			if ($mixContent instanceof QQNode) {
				...
				if ($mixContent->_RootTableName == 'other_contact_method') {
					...
					throw new QCallerException('Content QQNode has a root table of "' . $mixContent->_RootTableName . '". Must be a root of "other_contact_method".');
			} else if (is_string($mixContent)) switch ($mixContent) {
				case 'Id': return QQN::OtherContactMethod()->Id;
				case 'Name': return QQN::OtherContactMethod()->Name;
				default: throw new QCallerException('Simple Property not found in OtherContactMethodDataGrid content: ' . $mixContent);
