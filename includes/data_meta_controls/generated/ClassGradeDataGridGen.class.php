<?php
	 ...
	 * listing a collection of ClassGrade objects.  It includes
	 ...
	 * 
	 */
	class ClassGradeDataGridGen extends QDataGrid {
		/**
		 ...
		 * way of adding a column to this ClassGrade datagrid.  The description of a column's
		 * content can be either a text string description of a simple field name
		 * in the ClassGrade object, or it can be any QQNode extending from QQN::ClassGrade().
		 * 
		 ...
		 * sorting using two fields from the ClassGrade object.
		 *
		 ...
		 *
		 * @param mixed $mixContent string or QQNode from ClassGrade
		...
		public function MetaDataBinder(QQCondition $objCondition = null, $objOptionalClauses = null) {
			...
			if ($this->Paginator) $this->TotalItemCount = ClassGrade::QueryCount($objCondition, $objClauses);
		 ...
		 *
		 * Given a QQNode or a Text String, this will return a ClassGrade-based QQNode.
		 * It will also verify that it is a proper ClassGrade-based QQNode, and will throw an exception otherwise.
		 *
		...
		protected function ResolveContentItem($mixContent) {
			if ($mixContent instanceof QQNode) {
				...
				if ($mixContent->_RootTableName == 'class_grade') {
					...
					throw new QCallerException('Content QQNode has a root table of "' . $mixContent->_RootTableName . '". Must be a root of "class_grade".');
			} else if (is_string($mixContent)) switch ($mixContent) {
				case 'Id': return QQN::ClassGrade()->Id;
				case 'Code': return QQN::ClassGrade()->Code;
				case 'Name': return QQN::ClassGrade()->Name;
				default: throw new QCallerException('Simple Property not found in ClassGradeDataGrid content: ' . $mixContent);
