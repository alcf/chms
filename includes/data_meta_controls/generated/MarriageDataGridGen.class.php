<?php
	 ...
	 * listing a collection of Marriage objects.  It includes
	 ...
	 * 
	 */
	class MarriageDataGridGen extends QDataGrid {
		/**
		 ...
		 * way of adding a column to this Marriage datagrid.  The description of a column's
		 * content can be either a text string description of a simple field name
		 * in the Marriage object, or it can be any QQNode extending from QQN::Marriage().
		 * 
		 ...
		 * sorting using two fields from the Marriage object.
		 *
		 ...
		 *
		 * @param mixed $mixContent string or QQNode from Marriage
		...
		public function MetaDataBinder(QQCondition $objCondition = null, $objOptionalClauses = null) {
			...
			if ($this->Paginator) $this->TotalItemCount = Marriage::QueryCount($objCondition, $objClauses);
		 ...
		 *
		 * Given a QQNode or a Text String, this will return a Marriage-based QQNode.
		 * It will also verify that it is a proper Marriage-based QQNode, and will throw an exception otherwise.
		 *
		...
		protected function ResolveContentItem($mixContent) {
			if ($mixContent instanceof QQNode) {
				...
				if ($mixContent->_RootTableName == 'marriage') {
				...
				case 'MarriedToPerson': return QQN::Marriage()->MarriedToPerson;
