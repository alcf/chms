<?php
	...
	class CommentDataGridGen extends QDataGrid {
		...
		public function MetaDataBinder(QQCondition $objCondition = null, $objOptionalClauses = null) {
			...
			if ($this->Paginator) $this->TotalItemCount = Comment::QueryCount($objCondition, $objClauses);
			...
			$this->DataSource = Comment::QueryArray($objCondition, $objClauses);
		}
		...
		protected function ResolveContentItem($mixContent) {
			if ($mixContent instanceof QQNode) {
				...
				case 'PersonId': return QQN::Comment()->PersonId;
				case 'Person': return QQN::Comment()->Person;
				case 'PostedByLoginId': return QQN::Comment()->PostedByLoginId;
				case 'PostedByLogin': return QQN::Comment()->PostedByLogin;
				case 'CommentPrivacyTypeId': return QQN::Comment()->CommentPrivacyTypeId;
				case 'CommentCategoryId': return QQN::Comment()->CommentCategoryId;
