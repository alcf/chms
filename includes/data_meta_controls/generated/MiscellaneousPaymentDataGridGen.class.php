<?php
	 ...
	 * listing a collection of MiscellaneousPayment objects.  It includes
	 ...
	 * 
	 */
	class MiscellaneousPaymentDataGridGen extends QDataGrid {
		/**
		 ...
		 * way of adding a column to this MiscellaneousPayment datagrid.  The description of a column's
		 * content can be either a text string description of a simple field name
		 * in the MiscellaneousPayment object, or it can be any QQNode extending from QQN::MiscellaneousPayment().
		 * 
		 ...
		 * sorting using two fields from the MiscellaneousPayment object.
		 *
		 ...
		 *
		 * @param mixed $mixContent string or QQNode from MiscellaneousPayment
		...
		public function MetaDataBinder(QQCondition $objCondition = null, $objOptionalClauses = null) {
			...
			if ($this->Paginator) $this->TotalItemCount = MiscellaneousPayment::QueryCount($objCondition, $objClauses);
			...
			// Set the DataSource to be a Query result from MiscellaneousPayment, given the clauses above
			$this->DataSource = MiscellaneousPayment::QueryArray($objCondition, $objClauses);
		}
		 ...
		 *
		 * Given a QQNode or a Text String, this will return a MiscellaneousPayment-based QQNode.
		 * It will also verify that it is a proper MiscellaneousPayment-based QQNode, and will throw an exception otherwise.
		 *
		...
		protected function ResolveContentItem($mixContent) {
			if ($mixContent instanceof QQNode) {
				...
				if ($mixContent->_RootTableName == 'miscellaneous_payment') {
					...
					throw new QCallerException('Content QQNode has a root table of "' . $mixContent->_RootTableName . '". Must be a root of "miscellaneous_payment".');
			} else if (is_string($mixContent)) switch ($mixContent) {
				case 'Id': return QQN::MiscellaneousPayment()->Id;
				case 'PersonId': return QQN::MiscellaneousPayment()->PersonId;
				case 'Person': return QQN::MiscellaneousPayment()->Person;
				case 'CreditCardPaymentId': return QQN::MiscellaneousPayment()->CreditCardPaymentId;
				case 'CreditCardPayment': return QQN::MiscellaneousPayment()->CreditCardPayment;
				case 'TransactionDate': return QQN::MiscellaneousPayment()->TransactionDate;
				case 'TransactionDescription': return QQN::MiscellaneousPayment()->TransactionDescription;
				case 'Amount': return QQN::MiscellaneousPayment()->Amount;
				case 'FundingAccount': return QQN::MiscellaneousPayment()->FundingAccount;
				default: throw new QCallerException('Simple Property not found in MiscellaneousPaymentDataGrid content: ' . $mixContent);
