<?php
	 ...
	 * listing a collection of EventSignupForm objects.  It includes
	 ...
	 * 
	 */
	class EventSignupFormDataGridGen extends QDataGrid {
		/**
		 ...
		 * way of adding a column to this EventSignupForm datagrid.  The description of a column's
		 * content can be either a text string description of a simple field name
		 * in the EventSignupForm object, or it can be any QQNode extending from QQN::EventSignupForm().
		 * 
		 ...
		 * sorting using two fields from the EventSignupForm object.
		 *
		 ...
		 *
		 * @param mixed $mixContent string or QQNode from EventSignupForm
		...
		public function MetaDataBinder(QQCondition $objCondition = null, $objOptionalClauses = null) {
			...
			if ($this->Paginator) $this->TotalItemCount = EventSignupForm::QueryCount($objCondition, $objClauses);
		 ...
		 *
		 * Given a QQNode or a Text String, this will return a EventSignupForm-based QQNode.
		 * It will also verify that it is a proper EventSignupForm-based QQNode, and will throw an exception otherwise.
		 *
		...
		protected function ResolveContentItem($mixContent) {
			if ($mixContent instanceof QQNode) {
				...
				if ($mixContent->_RootTableName == 'event_signup_form') {
					...
					throw new QCallerException('Content QQNode has a root table of "' . $mixContent->_RootTableName . '". Must be a root of "event_signup_form".');
			} else if (is_string($mixContent)) switch ($mixContent) {
				case 'SignupFormId': return QQN::EventSignupForm()->SignupFormId;
				case 'SignupForm': return QQN::EventSignupForm()->SignupForm;
				case 'DateStart': return QQN::EventSignupForm()->DateStart;
				case 'DateEnd': return QQN::EventSignupForm()->DateEnd;
				case 'Location': return QQN::EventSignupForm()->Location;
				default: throw new QCallerException('Simple Property not found in EventSignupFormDataGrid content: ' . $mixContent);
