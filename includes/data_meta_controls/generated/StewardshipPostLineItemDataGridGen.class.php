<?php
	 ...
	 * listing a collection of StewardshipPostLineItem objects.  It includes
	 ...
	 * 
	 */
	class StewardshipPostLineItemDataGridGen extends QDataGrid {
		/**
		 ...
		 * way of adding a column to this StewardshipPostLineItem datagrid.  The description of a column's
		 * content can be either a text string description of a simple field name
		 * in the StewardshipPostLineItem object, or it can be any QQNode extending from QQN::StewardshipPostLineItem().
		 * 
		 ...
		 * sorting using two fields from the StewardshipPostLineItem object.
		 *
		 ...
		 *
		 * @param mixed $mixContent string or QQNode from StewardshipPostLineItem
		...
		public function MetaDataBinder(QQCondition $objCondition = null, $objOptionalClauses = null) {
			...
			if ($this->Paginator) $this->TotalItemCount = StewardshipPostLineItem::QueryCount($objCondition, $objClauses);
		 ...
		 *
		 * Given a QQNode or a Text String, this will return a StewardshipPostLineItem-based QQNode.
		 * It will also verify that it is a proper StewardshipPostLineItem-based QQNode, and will throw an exception otherwise.
		 *
		...
		protected function ResolveContentItem($mixContent) {
			if ($mixContent instanceof QQNode) {
				...
				if ($mixContent->_RootTableName == 'stewardship_post_line_item') {
					...
					throw new QCallerException('Content QQNode has a root table of "' . $mixContent->_RootTableName . '". Must be a root of "stewardship_post_line_item".');
			} else if (is_string($mixContent)) switch ($mixContent) {
				case 'Id': return QQN::StewardshipPostLineItem()->Id;
				case 'StewardshipPostId': return QQN::StewardshipPostLineItem()->StewardshipPostId;
				case 'StewardshipPost': return QQN::StewardshipPostLineItem()->StewardshipPost;
				case 'StewardshipContributionId': return QQN::StewardshipPostLineItem()->StewardshipContributionId;
				case 'StewardshipContribution': return QQN::StewardshipPostLineItem()->StewardshipContribution;
				case 'PersonId': return QQN::StewardshipPostLineItem()->PersonId;
				case 'Person': return QQN::StewardshipPostLineItem()->Person;
				case 'StewardshipFundId': return QQN::StewardshipPostLineItem()->StewardshipFundId;
				case 'StewardshipFund': return QQN::StewardshipPostLineItem()->StewardshipFund;
				case 'Description': return QQN::StewardshipPostLineItem()->Description;
				case 'Amount': return QQN::StewardshipPostLineItem()->Amount;
				default: throw new QCallerException('Simple Property not found in StewardshipPostLineItemDataGrid content: ' . $mixContent);
