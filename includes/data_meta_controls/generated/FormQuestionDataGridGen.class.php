<?php
	 ...
	 * listing a collection of FormQuestion objects.  It includes
	 ...
	 * 
	 */
	class FormQuestionDataGridGen extends QDataGrid {
		/**
		 ...
		 * way of adding a column to this FormQuestion datagrid.  The description of a column's
		 * content can be either a text string description of a simple field name
		 * in the FormQuestion object, or it can be any QQNode extending from QQN::FormQuestion().
		 * 
		 ...
		 * sorting using two fields from the FormQuestion object.
		 *
		 ...
		 *
		 * @param mixed $mixContent string or QQNode from FormQuestion
		...
		public function MetaDataBinder(QQCondition $objCondition = null, $objOptionalClauses = null) {
			...
			if ($this->Paginator) $this->TotalItemCount = FormQuestion::QueryCount($objCondition, $objClauses);
		...
		protected function ResolveContentItem($mixContent) {
			if ($mixContent instanceof QQNode) {
				...
				case 'Id': return QQN::FormQuestion()->Id;
				case 'SignupFormId': return QQN::FormQuestion()->SignupFormId;
				case 'SignupForm': return QQN::FormQuestion()->SignupForm;
				case 'OrderNumber': return QQN::FormQuestion()->OrderNumber;
				case 'FormQuestionTypeId': return QQN::FormQuestion()->FormQuestionTypeId;
