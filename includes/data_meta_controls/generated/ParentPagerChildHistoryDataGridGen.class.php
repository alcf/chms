<?php
	 ...
	 * listing a collection of ParentPagerChildHistory objects.  It includes
	 ...
	 * 
	 */
	class ParentPagerChildHistoryDataGridGen extends QDataGrid {
		/**
		 ...
		 * way of adding a column to this ParentPagerChildHistory datagrid.  The description of a column's
		 * content can be either a text string description of a simple field name
		 * in the ParentPagerChildHistory object, or it can be any QQNode extending from QQN::ParentPagerChildHistory().
		 * 
		 ...
		 * sorting using two fields from the ParentPagerChildHistory object.
		 *
		 ...
		 *
		 * @param mixed $mixContent string or QQNode from ParentPagerChildHistory
		...
		public function MetaDataBinder(QQCondition $objCondition = null, $objOptionalClauses = null) {
			...
			if ($this->Paginator) $this->TotalItemCount = ParentPagerChildHistory::QueryCount($objCondition, $objClauses);
			...
			// Set the DataSource to be a Query result from ParentPagerChildHistory, given the clauses above
			$this->DataSource = ParentPagerChildHistory::QueryArray($objCondition, $objClauses);
		}
		 ...
		 *
		 * Given a QQNode or a Text String, this will return a ParentPagerChildHistory-based QQNode.
		 * It will also verify that it is a proper ParentPagerChildHistory-based QQNode, and will throw an exception otherwise.
		 *
		...
		protected function ResolveContentItem($mixContent) {
			if ($mixContent instanceof QQNode) {
				...
				if ($mixContent->_RootTableName == 'parent_pager_child_history') {
					...
					throw new QCallerException('Content QQNode has a root table of "' . $mixContent->_RootTableName . '". Must be a root of "parent_pager_child_history".');
			} else if (is_string($mixContent)) switch ($mixContent) {
				case 'Id': return QQN::ParentPagerChildHistory()->Id;
				case 'ServerIdentifier': return QQN::ParentPagerChildHistory()->ServerIdentifier;
				case 'ParentPagerIndividualId': return QQN::ParentPagerChildHistory()->ParentPagerIndividualId;
				case 'ParentPagerIndividual': return QQN::ParentPagerChildHistory()->ParentPagerIndividual;
				case 'ParentPagerStationId': return QQN::ParentPagerChildHistory()->ParentPagerStationId;
				case 'ParentPagerStation': return QQN::ParentPagerChildHistory()->ParentPagerStation;
				case 'ParentPagerPeriodId': return QQN::ParentPagerChildHistory()->ParentPagerPeriodId;
				case 'ParentPagerPeriod': return QQN::ParentPagerChildHistory()->ParentPagerPeriod;
				case 'DropoffByParentPagerIndividualId': return QQN::ParentPagerChildHistory()->DropoffByParentPagerIndividualId;
				case 'DropoffByParentPagerIndividual': return QQN::ParentPagerChildHistory()->DropoffByParentPagerIndividual;
				case 'PickupByParentPagerIndividualId': return QQN::ParentPagerChildHistory()->PickupByParentPagerIndividualId;
				case 'PickupByParentPagerIndividual': return QQN::ParentPagerChildHistory()->PickupByParentPagerIndividual;
				case 'DateIn': return QQN::ParentPagerChildHistory()->DateIn;
				case 'DateOut': return QQN::ParentPagerChildHistory()->DateOut;
				default: throw new QCallerException('Simple Property not found in ParentPagerChildHistoryDataGrid content: ' . $mixContent);
