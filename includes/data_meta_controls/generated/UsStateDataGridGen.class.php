<?php
	 ...
	 * listing a collection of UsState objects.  It includes
	 ...
	 * 
	 */
	class UsStateDataGridGen extends QDataGrid {
		/**
		 ...
		 * way of adding a column to this UsState datagrid.  The description of a column's
		 * content can be either a text string description of a simple field name
		 * in the UsState object, or it can be any QQNode extending from QQN::UsState().
		 * 
		 ...
		 * sorting using two fields from the UsState object.
		 *
		 ...
		 *
		 * @param mixed $mixContent string or QQNode from UsState
		...
		public function MetaDataBinder(QQCondition $objCondition = null, $objOptionalClauses = null) {
			...
			if ($this->Paginator) $this->TotalItemCount = UsState::QueryCount($objCondition, $objClauses);
			...
			// Set the DataSource to be a Query result from UsState, given the clauses above
			$this->DataSource = UsState::QueryArray($objCondition, $objClauses);
		}
		...
		protected function ResolveContentItem($mixContent) {
			if ($mixContent instanceof QQNode) {
				...
				case 'Id': return QQN::UsState()->Id;
				case 'Name': return QQN::UsState()->Name;
				case 'Abbreviation': return QQN::UsState()->Abbreviation;
				default: throw new QCallerException('Simple Property not found in UsStateDataGrid content: ' . $mixContent);
