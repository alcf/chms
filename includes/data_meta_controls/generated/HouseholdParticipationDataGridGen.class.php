<?php
	 ...
	 * listing a collection of HouseholdParticipation objects.  It includes
	 ...
	 * 
	 */
	class HouseholdParticipationDataGridGen extends QDataGrid {
		/**
		 ...
		 * way of adding a column to this HouseholdParticipation datagrid.  The description of a column's
		 * content can be either a text string description of a simple field name
		 * in the HouseholdParticipation object, or it can be any QQNode extending from QQN::HouseholdParticipation().
		 * 
		 ...
		 * sorting using two fields from the HouseholdParticipation object.
		 *
		 ...
		 *
		 * @param mixed $mixContent string or QQNode from HouseholdParticipation
		...
		public function MetaDataBinder() {
			...
			if ($this->Paginator) {
				$this->TotalItemCount = HouseholdParticipation::CountAll();
			}
			...
			$this->DataSource = HouseholdParticipation::LoadAll($objClauses);
		}
		...
		protected function ResolveContentItem($mixContent) {
			if ($mixContent instanceof QQNode) {
				...
				case 'Id': return QQN::HouseholdParticipation()->Id;
				case 'PersonId': return QQN::HouseholdParticipation()->PersonId;
				case 'Person': return QQN::HouseholdParticipation()->Person;
