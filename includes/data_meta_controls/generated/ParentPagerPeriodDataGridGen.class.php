<?php
	 ...
	 * listing a collection of ParentPagerPeriod objects.  It includes
	 ...
	 * 
	 */
	class ParentPagerPeriodDataGridGen extends QDataGrid {
		/**
		 ...
		 * way of adding a column to this ParentPagerPeriod datagrid.  The description of a column's
		 * content can be either a text string description of a simple field name
		 * in the ParentPagerPeriod object, or it can be any QQNode extending from QQN::ParentPagerPeriod().
		 * 
		 ...
		 * sorting using two fields from the ParentPagerPeriod object.
		 *
		 ...
		 *
		 * @param mixed $mixContent string or QQNode from ParentPagerPeriod
		...
		public function MetaDataBinder(QQCondition $objCondition = null, $objOptionalClauses = null) {
			...
			if ($this->Paginator) $this->TotalItemCount = ParentPagerPeriod::QueryCount($objCondition, $objClauses);
		 ...
		 *
		 * Given a QQNode or a Text String, this will return a ParentPagerPeriod-based QQNode.
		 * It will also verify that it is a proper ParentPagerPeriod-based QQNode, and will throw an exception otherwise.
		 *
		...
		protected function ResolveContentItem($mixContent) {
			if ($mixContent instanceof QQNode) {
				...
				if ($mixContent->_RootTableName == 'parent_pager_period') {
					...
					throw new QCallerException('Content QQNode has a root table of "' . $mixContent->_RootTableName . '". Must be a root of "parent_pager_period".');
			} else if (is_string($mixContent)) switch ($mixContent) {
				case 'Id': return QQN::ParentPagerPeriod()->Id;
				case 'ServerIdentifier': return QQN::ParentPagerPeriod()->ServerIdentifier;
				case 'Name': return QQN::ParentPagerPeriod()->Name;
				default: throw new QCallerException('Simple Property not found in ParentPagerPeriodDataGrid content: ' . $mixContent);
