<?php
	 ...
	 * listing a collection of PaypalBatch objects.  It includes
	 ...
	 * 
	 */
	class PaypalBatchDataGridGen extends QDataGrid {
		/**
		 ...
		 * way of adding a column to this PaypalBatch datagrid.  The description of a column's
		 * content can be either a text string description of a simple field name
		 * in the PaypalBatch object, or it can be any QQNode extending from QQN::PaypalBatch().
		 * 
		 ...
		 * sorting using two fields from the PaypalBatch object.
		 *
		 ...
		 *
		 * @param mixed $mixContent string or QQNode from PaypalBatch
		...
		public function MetaDataBinder(QQCondition $objCondition = null, $objOptionalClauses = null) {
			...
			if ($this->Paginator) $this->TotalItemCount = PaypalBatch::QueryCount($objCondition, $objClauses);
		 ...
		 *
		 * Given a QQNode or a Text String, this will return a PaypalBatch-based QQNode.
		 * It will also verify that it is a proper PaypalBatch-based QQNode, and will throw an exception otherwise.
		 *
		...
		protected function ResolveContentItem($mixContent) {
			if ($mixContent instanceof QQNode) {
				...
				if ($mixContent->_RootTableName == 'paypal_batch') {
					...
					throw new QCallerException('Content QQNode has a root table of "' . $mixContent->_RootTableName . '". Must be a root of "paypal_batch".');
