<?php
	 ...
	 * listing a collection of OtherContactInfo objects.  It includes
	 ...
	 * 
	 */
	class OtherContactInfoDataGridGen extends QDataGrid {
		/**
		 ...
		 * way of adding a column to this OtherContactInfo datagrid.  The description of a column's
		 * content can be either a text string description of a simple field name
		 * in the OtherContactInfo object, or it can be any QQNode extending from QQN::OtherContactInfo().
		 * 
		 ...
		 * sorting using two fields from the OtherContactInfo object.
		 *
		 ...
		 *
		 * @param mixed $mixContent string or QQNode from OtherContactInfo
		...
		public function MetaDataBinder(QQCondition $objCondition = null, $objOptionalClauses = null) {
			...
			if ($this->Paginator) $this->TotalItemCount = OtherContactInfo::QueryCount($objCondition, $objClauses);
			...
			// Set the DataSource to be a Query result from OtherContactInfo, given the clauses above
			$this->DataSource = OtherContactInfo::QueryArray($objCondition, $objClauses);
		}
		 ...
		 *
		 * Given a QQNode or a Text String, this will return a OtherContactInfo-based QQNode.
		 * It will also verify that it is a proper OtherContactInfo-based QQNode, and will throw an exception otherwise.
		 *
		...
		protected function ResolveContentItem($mixContent) {
			if ($mixContent instanceof QQNode) {
				...
				if ($mixContent->_RootTableName == 'other_contact_info') {
					...
					throw new QCallerException('Content QQNode has a root table of "' . $mixContent->_RootTableName . '". Must be a root of "other_contact_info".');
			} else if (is_string($mixContent)) switch ($mixContent) {
				case 'Id': return QQN::OtherContactInfo()->Id;
				case 'PersonId': return QQN::OtherContactInfo()->PersonId;
				case 'Person': return QQN::OtherContactInfo()->Person;
				case 'OtherContactMethodId': return QQN::OtherContactInfo()->OtherContactMethodId;
				case 'OtherContactMethod': return QQN::OtherContactInfo()->OtherContactMethod;
				case 'Value': return QQN::OtherContactInfo()->Value;
				default: throw new QCallerException('Simple Property not found in OtherContactInfoDataGrid content: ' . $mixContent);
