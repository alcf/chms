<?php
	 ...
	 * listing a collection of FormProduct objects.  It includes
	 ...
	 * 
	 */
	class FormProductDataGridGen extends QDataGrid {
		/**
		 ...
		 * way of adding a column to this FormProduct datagrid.  The description of a column's
		 * content can be either a text string description of a simple field name
		 * in the FormProduct object, or it can be any QQNode extending from QQN::FormProduct().
		 * 
		 ...
		 * sorting using two fields from the FormProduct object.
		 *
		 ...
		 *
		 * @param mixed $mixContent string or QQNode from FormProduct
		...
		public function MetaDataBinder(QQCondition $objCondition = null, $objOptionalClauses = null) {
			...
			if ($this->Paginator) $this->TotalItemCount = FormProduct::QueryCount($objCondition, $objClauses);
