<?php
	 ...
	 * listing a collection of ParentPagerStation objects.  It includes
	 ...
	 * 
	 */
	class ParentPagerStationDataGridGen extends QDataGrid {
		/**
		 ...
		 * way of adding a column to this ParentPagerStation datagrid.  The description of a column's
		 * content can be either a text string description of a simple field name
		 * in the ParentPagerStation object, or it can be any QQNode extending from QQN::ParentPagerStation().
		 * 
		 ...
		 * sorting using two fields from the ParentPagerStation object.
		 *
		 ...
		 *
		 * @param mixed $mixContent string or QQNode from ParentPagerStation
		...
		public function MetaDataBinder(QQCondition $objCondition = null, $objOptionalClauses = null) {
			...
			if ($this->Paginator) $this->TotalItemCount = ParentPagerStation::QueryCount($objCondition, $objClauses);
		 ...
		 *
		 * Given a QQNode or a Text String, this will return a ParentPagerStation-based QQNode.
		 * It will also verify that it is a proper ParentPagerStation-based QQNode, and will throw an exception otherwise.
		 *
		...
		protected function ResolveContentItem($mixContent) {
			if ($mixContent instanceof QQNode) {
				...
				if ($mixContent->_RootTableName == 'parent_pager_station') {
					...
					throw new QCallerException('Content QQNode has a root table of "' . $mixContent->_RootTableName . '". Must be a root of "parent_pager_station".');
			} else if (is_string($mixContent)) switch ($mixContent) {
				case 'Id': return QQN::ParentPagerStation()->Id;
				case 'ServerIdentifier': return QQN::ParentPagerStation()->ServerIdentifier;
				case 'Name': return QQN::ParentPagerStation()->Name;
				default: throw new QCallerException('Simple Property not found in ParentPagerStationDataGrid content: ' . $mixContent);
