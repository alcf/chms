<?php
	 ...
	 * listing a collection of Membership objects.  It includes
	 ...
	 * 
	 */
	class MembershipDataGridGen extends QDataGrid {
		/**
		 ...
		 * way of adding a column to this Membership datagrid.  The description of a column's
		 * content can be either a text string description of a simple field name
		 * in the Membership object, or it can be any QQNode extending from QQN::Membership().
		 * 
		 ...
		 * sorting using two fields from the Membership object.
		 *
		 ...
		 *
		 * @param mixed $mixContent string or QQNode from Membership
		...
		public function MetaDataBinder(QQCondition $objCondition = null, $objOptionalClauses = null) {
			...
			if ($this->Paginator) $this->TotalItemCount = Membership::QueryCount($objCondition, $objClauses);
			...
			// Set the DataSource to be a Query result from Membership, given the clauses above
			$this->DataSource = Membership::QueryArray($objCondition, $objClauses);
		}
		...
		protected function ResolveContentItem($mixContent) {
			if ($mixContent instanceof QQNode) {
				...
				case 'Id': return QQN::Membership()->Id;
				case 'PersonId': return QQN::Membership()->PersonId;
				case 'Person': return QQN::Membership()->Person;
				case 'DateStart': return QQN::Membership()->DateStart;
				case 'DateEnd': return QQN::Membership()->DateEnd;
				case 'TerminationReason': return QQN::Membership()->TerminationReason;
				default: throw new QCallerException('Simple Property not found in MembershipDataGrid content: ' . $mixContent);
