...
`login_not_required_flag` BOOLEAN,
PRIMARY KEY (`id`)
) ENGINE=InnoDB;
...
`internal_notes` TEXT,
`communications_entry_id` INTEGER UNSIGNED,
PRIMARY KEY (`id`)
) ENGINE=InnoDB;
...
(
`id` INTEGER UNSIGNED NOT NULL AUTO_INCREMENT,
`source_list_id` INTEGER UNSIGNED NOT NULL,
`date_received` DATE,
`first_name` VARCHAR(100),
`last_name` VARCHAR(100),
`gender` VARCHAR(1),
...
`preferred_location1` VARCHAR(255),
`preferred_location2` VARCHAR(255),
`city` VARCHAR(255),
`zipcode` VARCHAR(10),
`group_day` VARCHAR(255),
`groups_placed` VARCHAR(512),
`date_processed` DATE,
...
(
`group_registrations_id` INTEGER UNSIGNED NOT NULL,
`group_structure_id` INTEGER UNSIGNED NOT NULL,
...
ALTER TABLE `signup_form` ADD FOREIGN KEY ministry_id_idxfk_2 (`ministry_id`) REFERENCES `ministry` (`id`);
...
ALTER TABLE `form_question` ADD FOREIGN KEY signup_form_id_idxfk (`signup_form_id`) REFERENCES `signup_form` (`id`);
...
ALTER TABLE `form_product` ADD FOREIGN KEY signup_form_id_idxfk_1 (`signup_form_id`) REFERENCES `signup_form` (`id`);
...
ALTER TABLE `event_signup_form` ADD FOREIGN KEY signup_form_id_idxfk_2 (`signup_form_id`) REFERENCES `signup_form` (`id`);

CREATE INDEX `person_id_idx` ON `parent_pager_individual`(`person_id`);
ALTER TABLE `parent_pager_individual` ADD FOREIGN KEY person_id_idxfk (`person_id`) REFERENCES `person` (`id`);
...
ALTER TABLE `parent_pager_individual` ADD FOREIGN KEY parent_pager_sync_status_type_id_idxfk (`parent_pager_sync_status_type_id`) REFERENCES `parent_pager_sync_status_type` (`id`);
...
ALTER TABLE `email` ADD FOREIGN KEY person_id_idxfk_2 (`person_id`) REFERENCES `person` (`id`);

CREATE INDEX `address_idx` ON `email`(`address`);
CREATE INDEX `person_id_idx` ON `comment`(`person_id`);
ALTER TABLE `comment` ADD FOREIGN KEY person_id_idxfk_3 (`person_id`) REFERENCES `person` (`id`);
...
ALTER TABLE `parent_pager_household` ADD FOREIGN KEY household_id_idxfk (`household_id`) REFERENCES `household` (`id`);
...
ALTER TABLE `parent_pager_household` ADD FOREIGN KEY parent_pager_sync_status_type_id_idxfk_1 (`parent_pager_sync_status_type_id`) REFERENCES `parent_pager_sync_status_type` (`id`);
...
ALTER TABLE `phone` ADD FOREIGN KEY person_id_idxfk_5 (`person_id`) REFERENCES `person` (`id`);
...
ALTER TABLE `membership` ADD FOREIGN KEY person_id_idxfk_7 (`person_id`) REFERENCES `person` (`id`);
...
ALTER TABLE `person` ADD FOREIGN KEY co_primary_idxfk (`co_primary`) REFERENCES `person` (`id`);
...
ALTER TABLE `communicationlist_person_assn` ADD FOREIGN KEY person_id_idxfk_11 (`person_id`) REFERENCES `person` (`id`);
...
ALTER TABLE `stewardship_pledge` ADD FOREIGN KEY person_id_idxfk_13 (`person_id`) REFERENCES `person` (`id`);
...
ALTER TABLE `signup_entry` ADD FOREIGN KEY person_id_idxfk_14 (`person_id`) REFERENCES `person` (`id`);
...
ALTER TABLE `signup_entry` ADD FOREIGN KEY communications_entry_id_idxfk (`communications_entry_id`) REFERENCES `communication_list_entry` (`id`);
...
ALTER TABLE `checkingaccountlookup_person_assn` ADD FOREIGN KEY person_id_idxfk_15 (`person_id`) REFERENCES `person` (`id`);
...
ALTER TABLE `household_split` ADD FOREIGN KEY household_id_idxfk_3 (`household_id`) REFERENCES `household` (`id`);
...
ALTER TABLE `other_contact_info` ADD FOREIGN KEY person_id_idxfk_16 (`person_id`) REFERENCES `person` (`id`);
...
ALTER TABLE `person_nameitem_assn` ADD FOREIGN KEY person_id_idxfk_17 (`person_id`) REFERENCES `person` (`id`);
...
ALTER TABLE `recurring_payments` ADD FOREIGN KEY credit_card_type_id_idxfk (`credit_card_type_id`) REFERENCES `credit_card_type` (`id`);
...
ALTER TABLE `stewardship_stack` ADD FOREIGN KEY stewardship_batch_id_idxfk_2 (`stewardship_batch_id`) REFERENCES `stewardship_batch` (`id`);
...
ALTER TABLE `stewardship_contribution` ADD FOREIGN KEY person_id_idxfk_18 (`person_id`) REFERENCES `person` (`id`);
...
ALTER TABLE `credit_card_payment` ADD FOREIGN KEY credit_card_type_id_idxfk_1 (`credit_card_type_id`) REFERENCES `credit_card_type` (`id`);
...
ALTER TABLE `credit_card_payment` ADD FOREIGN KEY stewardship_contribution_id_idxfk (`stewardship_contribution_id`) REFERENCES `stewardship_contribution` (`id`);

CREATE INDEX `signup_entry_id_idx` ON `signup_payment`(`signup_entry_id`);
ALTER TABLE `signup_payment` ADD FOREIGN KEY signup_entry_id_idxfk_2 (`signup_entry_id`) REFERENCES `signup_entry` (`id`);
...
ALTER TABLE `online_donation` ADD FOREIGN KEY person_id_idxfk_19 (`person_id`) REFERENCES `person` (`id`);
...
ALTER TABLE `group_registrations` ADD FOREIGN KEY source_list_id_idxfk (`source_list_id`) REFERENCES `source_list` (`id`);

CREATE INDEX `group_role_id_idx` ON `group_registrations`(`group_role_id`);
ALTER TABLE `group_registrations` ADD FOREIGN KEY group_role_id_idxfk (`group_role_id`) REFERENCES `group_role` (`id`);

ALTER TABLE `groupregistrations_groupstructure_assn` ADD FOREIGN KEY group_registrations_id_idxfk (`group_registrations_id`) REFERENCES `group_registrations` (`id`);

ALTER TABLE `groupregistrations_groupstructure_assn` ADD FOREIGN KEY group_structure_id_idxfk (`group_structure_id`) REFERENCES `growth_group_structure` (`id`);
...
ALTER TABLE `class_registration` ADD FOREIGN KEY signup_entry_id_idxfk_3 (`signup_entry_id`) REFERENCES `signup_entry` (`id`);
...
ALTER TABLE `class_registration` ADD FOREIGN KEY person_id_idxfk_20 (`person_id`) REFERENCES `person` (`id`);
...
ALTER TABLE `group` ADD FOREIGN KEY ministry_id_idxfk_5 (`ministry_id`) REFERENCES `ministry` (`id`);
...
ALTER TABLE `group` ADD FOREIGN KEY status_idxfk (`status`) REFERENCES `availability_status` (`id`);
...
ALTER TABLE `group_participation` ADD FOREIGN KEY group_role_id_idxfk_1 (`group_role_id`) REFERENCES `group_role` (`id`);

CREATE INDEX `date_start_idx` ON `group_participation`(`date_start`);
CREATE INDEX `date_end_idx` ON `group_participation`(`date_end`);
CREATE INDEX `date_followup_idx` ON `group_participation`(`date_followup`);
...
CREATE INDEX `group_id_idx` ON `group_authorized_sender`(`group_id`);
ALTER TABLE `group_authorized_sender` ADD FOREIGN KEY group_id_idxfk_2 (`group_id`) REFERENCES `group` (`id`);

CREATE INDEX `person_id_idx` ON `group_authorized_sender`(`person_id`);
ALTER TABLE `group_authorized_sender` ADD FOREIGN KEY person_id_idxfk_22 (`person_id`) REFERENCES `person` (`id`);
...
ALTER TABLE `group_category` ADD FOREIGN KEY group_id_idxfk_4 (`group_id`) REFERENCES `group` (`id`);
...
ALTER TABLE `email_message_route` ADD FOREIGN KEY group_id_idxfk_5 (`group_id`) REFERENCES `group` (`id`);
...
ALTER TABLE `email_message_route` ADD FOREIGN KEY person_id_idxfk_23 (`person_id`) REFERENCES `person` (`id`);

ALTER TABLE `smart_group` ADD FOREIGN KEY group_id_idxfk_6 (`group_id`) REFERENCES `group` (`id`);
...
ALTER TABLE `search_query` ADD FOREIGN KEY person_id_idxfk_24 (`person_id`) REFERENCES `person` (`id`);
...
ALTER TABLE `stewardship_post_line_item` ADD FOREIGN KEY stewardship_contribution_id_idxfk_2 (`stewardship_contribution_id`) REFERENCES `stewardship_contribution` (`id`);

CREATE INDEX `person_id_idx` ON `stewardship_post_line_item`(`person_id`);
ALTER TABLE `stewardship_post_line_item` ADD FOREIGN KEY person_id_idxfk_25 (`person_id`) REFERENCES `person` (`id`);

CREATE INDEX `stewardship_fund_id_idx` ON `stewardship_post_line_item`(`stewardship_fund_id`);
ALTER TABLE `stewardship_post_line_item` ADD FOREIGN KEY stewardship_fund_id_idxfk_4 (`stewardship_fund_id`) REFERENCES `stewardship_fund` (`id`);

CREATE INDEX `person_id_idx` ON `recurring_donation`(`person_id`);
ALTER TABLE `recurring_donation` ADD FOREIGN KEY recurring_payment_id_idxfk_1 (`recurring_payment_id`) REFERENCES `recurring_payments` (`id`);
