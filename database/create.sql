...
ALTER TABLE `marriage` ADD FOREIGN KEY person_id_idxfk (`person_id`) REFERENCES `person` (`id`);
...
ALTER TABLE `checkingaccountlookup_person_assn` ADD FOREIGN KEY person_id_idxfk_4 (`person_id`) REFERENCES `person` (`id`);
...
ALTER TABLE `address` ADD FOREIGN KEY person_id_idxfk_8 (`person_id`) REFERENCES `person` (`id`);
...
ALTER TABLE `communicationlist_person_assn` ADD FOREIGN KEY person_id_idxfk_9 (`person_id`) REFERENCES `person` (`id`);

ALTER TABLE `communicationlist_communicationlistentry_assn` ADD FOREIGN KEY communication_list_id_idxfk_1 (`communication_list_id`) REFERENCES `communication_list` (`id`);
...
ALTER TABLE `group_participation` ADD FOREIGN KEY person_id_idxfk_12 (`person_id`) REFERENCES `person` (`id`);

CREATE INDEX `group_id_idx` ON `group_participation`(`group_id`);
ALTER TABLE `group_participation` ADD FOREIGN KEY group_id_idxfk_1 (`group_id`) REFERENCES `group` (`id`);
...
ALTER TABLE `search_query` ADD FOREIGN KEY person_id_idxfk_14 (`person_id`) REFERENCES `person` (`id`);
...
ALTER TABLE `growth_group` ADD FOREIGN KEY group_id_idxfk_3 (`group_id`) REFERENCES `group` (`id`);
...
ALTER TABLE `email_message_route` ADD FOREIGN KEY login_id_idxfk (`login_id`) REFERENCES `login` (`id`);
...
ALTER TABLE `stewardship_post_line_item` ADD FOREIGN KEY stewardship_post_id_idxfk (`stewardship_post_id`) REFERENCES `stewardship_post` (`id`);
...
ALTER TABLE `stewardship_post_amount` ADD FOREIGN KEY stewardship_post_id_idxfk_1 (`stewardship_post_id`) REFERENCES `stewardship_post` (`id`);
...
ALTER TABLE `ministry_login_assn` ADD FOREIGN KEY login_id_idxfk_1 (`login_id`) REFERENCES `login` (`id`);
