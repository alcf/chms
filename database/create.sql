...
(
`id` INTEGER UNSIGNED NOT NULL AUTO_INCREMENT,
`message_identifier` VARCHAR(255) NOT NULL UNIQUE,
`email_message_status_type_id` INTEGER UNSIGNED NOT NULL,
`raw_message` TEXT,
`date_received` DATETIME NOT NULL,
`received_from_person_id` INTEGER UNSIGNED,
`received_from_entry_id` INTEGER UNSIGNED,
...
CREATE INDEX `received_from_person_id_idx` ON `email_message`(`received_from_person_id`);
ALTER TABLE `email_message` ADD FOREIGN KEY received_from_person_id_idxfk (`received_from_person_id`) REFERENCES `person` (`id`);

CREATE INDEX `received_from_entry_id_idx` ON `email_message`(`received_from_entry_id`);
ALTER TABLE `email_message` ADD FOREIGN KEY received_from_entry_id_idxfk (`received_from_entry_id`) REFERENCES `communication_list_entry` (`id`);

CREATE INDEX `group_id_idx` ON `email_message`(`group_id`);
ALTER TABLE `email_message` ADD FOREIGN KEY group_id_idxfk_2 (`group_id`) REFERENCES `group` (`id`);

CREATE INDEX `communication_list_id_idx` ON `email_message`(`communication_list_id`);
ALTER TABLE `email_message` ADD FOREIGN KEY communication_list_id_idxfk_1 (`communication_list_id`) REFERENCES `communication_list` (`id`);
...
ALTER TABLE `other_contact_info` ADD FOREIGN KEY person_id_idxfk_2 (`person_id`) REFERENCES `person` (`id`);
...
ALTER TABLE `communicationlist_person_assn` ADD FOREIGN KEY person_id_idxfk_3 (`person_id`) REFERENCES `person` (`id`);
...
ALTER TABLE `relationship` ADD FOREIGN KEY person_id_idxfk_4 (`person_id`) REFERENCES `person` (`id`);
...
ALTER TABLE `household_participation` ADD FOREIGN KEY person_id_idxfk_6 (`person_id`) REFERENCES `person` (`id`);
...
ALTER TABLE `comment` ADD FOREIGN KEY person_id_idxfk_8 (`person_id`) REFERENCES `person` (`id`);
...
ALTER TABLE `address` ADD FOREIGN KEY person_id_idxfk_12 (`person_id`) REFERENCES `person` (`id`);
