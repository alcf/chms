...
ALTER TABLE other_contact_info ADD FOREIGN KEY person_id_idxfk_1 (person_id) REFERENCES person (id);
...
CREATE INDEX person_id_idx ON mug_shot(person_id);
ALTER TABLE mug_shot ADD FOREIGN KEY person_id_idxfk_2 (person_id) REFERENCES person (id);
...
ALTER TABLE person ADD FOREIGN KEY current_mug_shot_id_idxfk (current_mug_shot_id) REFERENCES mug_shot (id);
...
ALTER TABLE attribute_value ADD FOREIGN KEY attribute_id_idxfk (attribute_id) REFERENCES attribute (id);
...
ALTER TABLE attribute_option ADD FOREIGN KEY attribute_id_idxfk_1 (attribute_id) REFERENCES attribute (id);
