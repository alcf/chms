...
ALTER TABLE `ministry_login_assn` ADD FOREIGN KEY ministry_id_idxfk_2 (`ministry_id`) REFERENCES `ministry` (`id`);
...
ALTER TABLE `comment` ADD FOREIGN KEY person_id_idxfk (`person_id`) REFERENCES `person` (`id`);
...
ALTER TABLE `stewardship_contribution` ADD FOREIGN KEY person_id_idxfk_1 (`person_id`) REFERENCES `person` (`id`);
...
ALTER TABLE `stewardship_contribution` ADD FOREIGN KEY checking_account_lookup_id_idxfk (`checking_account_lookup_id`) REFERENCES `checking_account_lookup` (`id`);
...
ALTER TABLE `stewardship_post_line_item` ADD FOREIGN KEY stewardship_contribution_id_idxfk_1 (`stewardship_contribution_id`) REFERENCES `stewardship_contribution` (`id`);

CREATE INDEX `person_id_idx` ON `stewardship_post_line_item`(`person_id`);
ALTER TABLE `stewardship_post_line_item` ADD FOREIGN KEY person_id_idxfk_2 (`person_id`) REFERENCES `person` (`id`);
...
ALTER TABLE `stewardship_pledge` ADD FOREIGN KEY person_id_idxfk_3 (`person_id`) REFERENCES `person` (`id`);

CREATE INDEX `stewardship_fund_id_idx` ON `stewardship_pledge`(`stewardship_fund_id`);
ALTER TABLE `stewardship_pledge` ADD FOREIGN KEY stewardship_fund_id_idxfk_3 (`stewardship_fund_id`) REFERENCES `stewardship_fund` (`id`);
...
ALTER TABLE `search_query` ADD FOREIGN KEY person_id_idxfk_4 (`person_id`) REFERENCES `person` (`id`);
...
ALTER TABLE `checkingaccountlookup_person_assn` ADD FOREIGN KEY checking_account_lookup_id_idxfk_1 (`checking_account_lookup_id`) REFERENCES `checking_account_lookup` (`id`);

ALTER TABLE `checkingaccountlookup_person_assn` ADD FOREIGN KEY person_id_idxfk_6 (`person_id`) REFERENCES `person` (`id`);

ALTER TABLE `person_nameitem_assn` ADD FOREIGN KEY person_id_idxfk_7 (`person_id`) REFERENCES `person` (`id`);
...
ALTER TABLE `membership` ADD FOREIGN KEY person_id_idxfk_9 (`person_id`) REFERENCES `person` (`id`);

CREATE INDEX `date_start_idx` ON `membership`(`date_start`);
CREATE INDEX `person_id_idx` ON `email`(`person_id`);
ALTER TABLE `email` ADD FOREIGN KEY person_id_idxfk_10 (`person_id`) REFERENCES `person` (`id`);
...
ALTER TABLE `group_participation` ADD FOREIGN KEY person_id_idxfk_11 (`person_id`) REFERENCES `person` (`id`);

CREATE INDEX `group_id_idx` ON `group_participation`(`group_id`);
ALTER TABLE `group_participation` ADD FOREIGN KEY group_id_idxfk_3 (`group_id`) REFERENCES `group` (`id`);
...
ALTER TABLE `relationship` ADD FOREIGN KEY person_id_idxfk_12 (`person_id`) REFERENCES `person` (`id`);
...
ALTER TABLE `marriage` ADD FOREIGN KEY person_id_idxfk_13 (`person_id`) REFERENCES `person` (`id`);
...
ALTER TABLE `head_shot` ADD FOREIGN KEY person_id_idxfk_16 (`person_id`) REFERENCES `person` (`id`);
...
ALTER TABLE `communication_list` ADD FOREIGN KEY ministry_id_idxfk_4 (`ministry_id`) REFERENCES `ministry` (`id`);
...
ALTER TABLE `email_message_route` ADD FOREIGN KEY communication_list_id_idxfk (`communication_list_id`) REFERENCES `communication_list` (`id`);
...
ALTER TABLE `email_message_route` ADD FOREIGN KEY communication_list_entry_id_idxfk (`communication_list_entry_id`) REFERENCES `communication_list_entry` (`id`);
...
ALTER TABLE `communicationlist_person_assn` ADD FOREIGN KEY person_id_idxfk_19 (`person_id`) REFERENCES `person` (`id`);

ALTER TABLE `communicationlist_communicationlistentry_assn` ADD FOREIGN KEY communication_list_id_idxfk_2 (`communication_list_id`) REFERENCES `communication_list` (`id`);

ALTER TABLE `communicationlist_communicationlistentry_assn` ADD FOREIGN KEY communication_list_entry_id_idxfk_1 (`communication_list_entry_id`) REFERENCES `communication_list_entry` (`id`);
