...
ALTER TABLE address ADD FOREIGN KEY person_id_idxfk (person_id) REFERENCES person (id);
...
ALTER TABLE phone ADD FOREIGN KEY person_id_idxfk_3 (person_id) REFERENCES person (id);
...
ALTER TABLE mug_shot ADD FOREIGN KEY person_id_idxfk_7 (person_id) REFERENCES person (id);
