...
`qcodo_query_custom_table` TEXT,
`qcodo_query_custom_node` TEXT,
...
ALTER TABLE `stewardship_fund` ADD FOREIGN KEY ministry_id_idxfk_3 (`ministry_id`) REFERENCES `ministry` (`id`);
...
ALTER TABLE `stewardship_contribution` ADD FOREIGN KEY person_id_idxfk (`person_id`) REFERENCES `person` (`id`);
...
ALTER TABLE `comment` ADD FOREIGN KEY person_id_idxfk_2 (`person_id`) REFERENCES `person` (`id`);
...
ALTER TABLE `stewardship_pledge` ADD FOREIGN KEY person_id_idxfk_4 (`person_id`) REFERENCES `person` (`id`);
...
ALTER TABLE `group_participation` ADD FOREIGN KEY person_id_idxfk_5 (`person_id`) REFERENCES `person` (`id`);
...
ALTER TABLE `email_message_route` ADD FOREIGN KEY person_id_idxfk_6 (`person_id`) REFERENCES `person` (`id`);
...
ALTER TABLE `search_query` ADD FOREIGN KEY person_id_idxfk_16 (`person_id`) REFERENCES `person` (`id`);
...
ALTER TABLE `marriage` ADD FOREIGN KEY person_id_idxfk_17 (`person_id`) REFERENCES `person` (`id`);
...
ALTER TABLE `relationship` ADD FOREIGN KEY person_id_idxfk_18 (`person_id`) REFERENCES `person` (`id`);
...
ALTER TABLE `head_shot` ADD FOREIGN KEY person_id_idxfk_19 (`person_id`) REFERENCES `person` (`id`);
