...
ALTER TABLE `membership` ADD FOREIGN KEY person_id_idxfk_1 (`person_id`) REFERENCES `person` (`id`);
...
ALTER TABLE `checkaccountlookup_person_assn` ADD FOREIGN KEY person_id_idxfk_2 (`person_id`) REFERENCES `person` (`id`);
