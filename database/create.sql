...
CREATE TABLE `course_signup_form`
(
`signup_form_id` INTEGER UNSIGNED NOT NULL,
`class_meeting` INTEGER UNSIGNED NOT NULL UNIQUE,
PRIMARY KEY (`signup_form_id`)
) ENGINE=InnoDB;
...
ALTER TABLE `class_instructor` ADD FOREIGN KEY login_id_idxfk_2 (`login_id`) REFERENCES `login` (`id`);
...
ALTER TABLE `course_signup_form` ADD FOREIGN KEY signup_form_id_idxfk_4 (`signup_form_id`) REFERENCES `signup_form` (`id`);

ALTER TABLE `course_signup_form` ADD FOREIGN KEY class_meeting_idxfk (`class_meeting`) REFERENCES `class_meeting` (`id`);
...
ALTER TABLE `class_registration` ADD FOREIGN KEY class_meeting_id_idxfk (`class_meeting_id`) REFERENCES `class_meeting` (`id`);
...
ALTER TABLE `class_attendence` ADD FOREIGN KEY class_registration_id_idxfk (`class_registration_id`) REFERENCES `class_registration` (`id`);
