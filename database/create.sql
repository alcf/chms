...
ALTER TABLE `parent_pager_attendant_history` ADD FOREIGN KEY parent_pager_individual_id_idxfk (`parent_pager_individual_id`) REFERENCES `parent_pager_individual` (`id`);

CREATE INDEX `parent_pager_station_id_idx` ON `parent_pager_attendant_history`(`parent_pager_station_id`);
ALTER TABLE `parent_pager_attendant_history` ADD FOREIGN KEY parent_pager_station_id_idxfk (`parent_pager_station_id`) REFERENCES `parent_pager_station` (`id`);

CREATE INDEX `parent_pager_period_id_idx` ON `parent_pager_attendant_history`(`parent_pager_period_id`);
ALTER TABLE `parent_pager_attendant_history` ADD FOREIGN KEY parent_pager_period_id_idxfk (`parent_pager_period_id`) REFERENCES `parent_pager_period` (`id`);
...
ALTER TABLE `parent_pager_child_history` ADD FOREIGN KEY parent_pager_individual_id_idxfk_1 (`parent_pager_individual_id`) REFERENCES `parent_pager_individual` (`id`);

CREATE INDEX `parent_pager_station_id_idx` ON `parent_pager_child_history`(`parent_pager_station_id`);
ALTER TABLE `parent_pager_child_history` ADD FOREIGN KEY parent_pager_station_id_idxfk_1 (`parent_pager_station_id`) REFERENCES `parent_pager_station` (`id`);

CREATE INDEX `parent_pager_period_id_idx` ON `parent_pager_child_history`(`parent_pager_period_id`);
ALTER TABLE `parent_pager_child_history` ADD FOREIGN KEY parent_pager_period_id_idxfk_1 (`parent_pager_period_id`) REFERENCES `parent_pager_period` (`id`);
...
ALTER TABLE `search_query` ADD FOREIGN KEY person_id_idxfk_1 (`person_id`) REFERENCES `person` (`id`);
...
ALTER TABLE `public_login` ADD FOREIGN KEY person_id_idxfk_2 (`person_id`) REFERENCES `person` (`id`);
...
ALTER TABLE `household_participation` ADD FOREIGN KEY household_id_idxfk_3 (`household_id`) REFERENCES `household` (`id`);
...
ALTER TABLE `comment` ADD FOREIGN KEY person_id_idxfk_12 (`person_id`) REFERENCES `person` (`id`);
...
ALTER TABLE `group_authorized_sender` ADD FOREIGN KEY group_id_idxfk_3 (`group_id`) REFERENCES `group` (`id`);

CREATE INDEX `person_id_idx` ON `group_authorized_sender`(`person_id`);
ALTER TABLE `group_authorized_sender` ADD FOREIGN KEY person_id_idxfk_13 (`person_id`) REFERENCES `person` (`id`);
...
ALTER TABLE `stewardship_pledge` ADD FOREIGN KEY person_id_idxfk_14 (`person_id`) REFERENCES `person` (`id`);
...
ALTER TABLE `signup_entry` ADD FOREIGN KEY person_id_idxfk_15 (`person_id`) REFERENCES `person` (`id`);
...
ALTER TABLE `signup_product` ADD FOREIGN KEY signup_entry_id_idxfk (`signup_entry_id`) REFERENCES `signup_entry` (`id`);
...
ALTER TABLE `checkingaccountlookup_person_assn` ADD FOREIGN KEY person_id_idxfk_16 (`person_id`) REFERENCES `person` (`id`);
...
ALTER TABLE `sms_message` ADD FOREIGN KEY group_id_idxfk_4 (`group_id`) REFERENCES `group` (`id`);
...
ALTER TABLE `other_contact_info` ADD FOREIGN KEY person_id_idxfk_17 (`person_id`) REFERENCES `person` (`id`);
...
ALTER TABLE `person_nameitem_assn` ADD FOREIGN KEY person_id_idxfk_18 (`person_id`) REFERENCES `person` (`id`);
...
ALTER TABLE `email_message_route` ADD FOREIGN KEY communication_list_id_idxfk_1 (`communication_list_id`) REFERENCES `communication_list` (`id`);
...
ALTER TABLE `email_message_route` ADD FOREIGN KEY person_id_idxfk_19 (`person_id`) REFERENCES `person` (`id`);
...
ALTER TABLE `communicationlist_person_assn` ADD FOREIGN KEY person_id_idxfk_20 (`person_id`) REFERENCES `person` (`id`);
...
ALTER TABLE `group_participation` ADD FOREIGN KEY group_id_idxfk_6 (`group_id`) REFERENCES `group` (`id`);
...
ALTER TABLE `class_registration` ADD FOREIGN KEY person_id_idxfk_22 (`person_id`) REFERENCES `person` (`id`);
...
ALTER TABLE `stewardship_contribution` ADD FOREIGN KEY person_id_idxfk_23 (`person_id`) REFERENCES `person` (`id`);
...
ALTER TABLE `stewardship_post_line_item` ADD FOREIGN KEY person_id_idxfk_24 (`person_id`) REFERENCES `person` (`id`);
...
ALTER TABLE `credit_card_payment` ADD FOREIGN KEY stewardship_contribution_id_idxfk_1 (`stewardship_contribution_id`) REFERENCES `stewardship_contribution` (`id`);
...
ALTER TABLE `stewardship_contribution_amount` ADD FOREIGN KEY stewardship_contribution_id_idxfk_2 (`stewardship_contribution_id`) REFERENCES `stewardship_contribution` (`id`);
