...
ALTER TABLE group_authorized_sender ADD FOREIGN KEY group_id_idxfk_6 (group_id) REFERENCES group (id);

CREATE INDEX person_id_idx ON group_authorized_sender(person_id);
ALTER TABLE group_authorized_sender ADD FOREIGN KEY person_id_idxfk_25 (person_id) REFERENCES person (id);
