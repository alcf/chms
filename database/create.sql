...
ALTER TABLE `checkaccountlookup_person_assn` ADD FOREIGN KEY person_id_idxfk_6 (`person_id`) REFERENCES `person` (`id`);
...
ALTER TABLE `stewardship_contribution` ADD FOREIGN KEY person_id_idxfk_7 (`person_id`) REFERENCES `person` (`id`);
