...
ALTER TABLE `head_shot` ADD FOREIGN KEY person_id_idxfk (`person_id`) REFERENCES `person` (`id`);
...
ALTER TABLE `person_nameitem_assn` ADD FOREIGN KEY person_id_idxfk_3 (`person_id`) REFERENCES `person` (`id`);
...
ALTER TABLE `group_participation` ADD FOREIGN KEY person_id_idxfk_13 (`person_id`) REFERENCES `person` (`id`);
...
ALTER TABLE `email_message` ADD FOREIGN KEY group_id_idxfk_3 (`group_id`) REFERENCES `group` (`id`);

CREATE INDEX `communication_list_id_idx` ON `email_message`(`communication_list_id`);
ALTER TABLE `email_message` ADD FOREIGN KEY communication_list_id_idxfk_2 (`communication_list_id`) REFERENCES `communication_list` (`id`);
