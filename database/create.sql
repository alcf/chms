...
ALTER TABLE relationship ADD FOREIGN KEY person_id_idxfk_3 (person_id) REFERENCES person (id);
...
ALTER TABLE mug_shot ADD FOREIGN KEY person_id_idxfk_8 (person_id) REFERENCES person (id);
...
ALTER TABLE household_participation ADD FOREIGN KEY person_id_idxfk_11 (person_id) REFERENCES person (id);
