...
CREATE TABLE `awcbtabl` (
    ...
    `income_account_none` INTEGER,
    `checking_account_none` INTEGER,
    `income_account_past` INTEGER,
    `checking_account_past` INTEGER,
    `income_account_future` INTEGER,
    `checking_account_future` INTEGER,
