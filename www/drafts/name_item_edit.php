...
//		protected function Form_PreRender() {}
		...
		protected function Form_Create() {
			// Use the CreateFromPathInfo shortcut (this can also be done manually using the NameItemMetaControl constructor)
			// MAKE SURE we specify "$this" as the MetaControl's (and thus all subsequent controls') parent
			$this->mctNameItem = NameItemMetaControl::CreateFromPathInfo($this);
		...
		protected function RedirectToListPage() {
			QApplication::Redirect(__VIRTUAL_DIRECTORY__ . __FORM_DRAFTS__ . '/name_item_list.php');
		}
	}

	// Go ahead and run this form object to render the page and its event handlers, implicitly using
	// name_item_edit.tpl.php as the included HTML template file
	NameItemEditForm::Run('NameItemEditForm');
?>