<?php
	 ...
	 * @subpackage Drafts
	 */
	class StewardshipPostLineItemEditPanel extends QPanel {
		...
		public function __construct($objParentObject, $strClosePanelMethod, $intId = null, $strControlId = null) {
			...
			$this->strTemplate = 'StewardshipPostLineItemEditPanel.tpl.php';
			$this->strClosePanelMethod = $strClosePanelMethod;

			// Construct the StewardshipPostLineItemMetaControl
			// MAKE SURE we specify "$this" as the MetaControl's (and thus all subsequent controls') parent
			$this->mctStewardshipPostLineItem = StewardshipPostLineItemMetaControl::Create($this, $intId);
