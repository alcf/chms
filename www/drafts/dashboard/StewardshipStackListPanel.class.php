<?php
	 ...
	 * list a collection of StewardshipStack objects.  It includes
	 * functionality to perform pagination and sorting on columns.
	 *
	 * To take advantage of some (or all) of these control objects, you
	 * must create a new QPanel which extends this StewardshipStackListPanelBase
	 * class.
	 *
	 ...
	 * 
	 */
	class StewardshipStackListPanel extends QPanel {
		// Local instance of the Meta DataGrid to list StewardshipStacks
		public $dtgStewardshipStacks;
		...
		public function __construct($objParentObject, $strSetEditPanelMethod, $strCloseEditPanelMethod, $strControlId = null) {
			...
			// Setup the Template
			$this->Template = 'StewardshipStackListPanel.tpl.php';
			...
			$this->dtgStewardshipStacks->ItemsPerPage = 8;
			...
			$this->dtgStewardshipStacks->MetaAddEditProxyColumn($this->pxyEdit, 'Edit', 'Edit');
			...
			$this->btnCreateNew->Text = QApplication::Translate('Create a New') . ' ' . QApplication::Translate('StewardshipStack');
			$this->btnCreateNew->AddAction(new QClickEvent(), new QAjaxControlAction($this, 'btnCreateNew_Click'));
		}

		public function pxyEdit_Click($strFormId, $strControlId, $strParameter) {
			$strParameterArray = explode(',', $strParameter);
			$objEditPanel = new StewardshipStackEditPanel($this, $this->strCloseEditPanelMethod, $strParameterArray[0]);
		...
		public function btnCreateNew_Click($strFormId, $strControlId, $strParameter) {
			$objEditPanel = new StewardshipStackEditPanel($this, $this->strCloseEditPanelMethod, null);
			$strMethodName = $this->strSetEditPanelMethod;
			$this->objForm->$strMethodName($objEditPanel);
		}
	}
