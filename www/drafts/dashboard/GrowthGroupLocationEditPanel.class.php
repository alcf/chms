<?php
	 ...
	 * @subpackage Drafts
	 */
	class GrowthGroupLocationEditPanel extends QPanel {
		...
		public function __construct($objParentObject, $strClosePanelMethod, $intId = null, $strControlId = null) {
			...
			$this->strTemplate = 'GrowthGroupLocationEditPanel.tpl.php';
			$this->strClosePanelMethod = $strClosePanelMethod;

			// Construct the GrowthGroupLocationMetaControl
			// MAKE SURE we specify "$this" as the MetaControl's (and thus all subsequent controls') parent
			$this->mctGrowthGroupLocation = GrowthGroupLocationMetaControl::Create($this, $intId);
			...
			$this->btnDelete->Visible = $this->mctGrowthGroupLocation->EditMode;
		}
