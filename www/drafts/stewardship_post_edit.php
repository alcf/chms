<?php
	 ...
	 * @subpackage Drafts
	 */
	class StewardshipPostEditForm extends ChmsForm {
...
//		protected function Form_PreRender() {}
		...
		protected function Form_Create() {
			// Use the CreateFromPathInfo shortcut (this can also be done manually using the StewardshipPostMetaControl constructor)
			// MAKE SURE we specify "$this" as the MetaControl's (and thus all subsequent controls') parent
			$this->mctStewardshipPost = StewardshipPostMetaControl::CreateFromPathInfo($this);
		...
		protected function RedirectToListPage() {
			QApplication::Redirect(__VIRTUAL_DIRECTORY__ . __FORM_DRAFTS__ . '/stewardship_post_list.php');
		}
	}

	// Go ahead and run this form object to render the page and its event handlers, implicitly using
	// stewardship_post_edit.tpl.php as the included HTML template file
	StewardshipPostEditForm::Run('StewardshipPostEditForm');
?>