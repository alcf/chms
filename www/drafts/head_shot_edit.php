...
//		protected function Form_PreRender() {}
		...
		protected function Form_Create() {
			// Use the CreateFromPathInfo shortcut (this can also be done manually using the HeadShotMetaControl constructor)
			// MAKE SURE we specify "$this" as the MetaControl's (and thus all subsequent controls') parent
			$this->mctHeadShot = HeadShotMetaControl::CreateFromPathInfo($this);
		...
		protected function RedirectToListPage() {
			QApplication::Redirect(__VIRTUAL_DIRECTORY__ . __FORM_DRAFTS__ . '/head_shot_list.php');
		}
	}

	// Go ahead and run this form object to render the page and its event handlers, implicitly using
	// head_shot_edit.tpl.php as the included HTML template file
	HeadShotEditForm::Run('HeadShotEditForm');
?>