...
?>
		...
		strHtml = strHtml.replace('<a href="/login.asp">Login</a>', '<a href="https://my.alcf.net/logout/">Log Out</a>');
...
?>
		...
		strHtml = strHtml.replace('<a href="/login.asp">Login</a>', '<a href="https://my.alcf.net/">Log In</a>');
