<?php require(__INCLUDES__ . '/header.inc.php'); ?>
	...
	<div class="section">
		...
		<div class="filterBy">Email<br/><?php $this->txtEmail->Render('Width=150px'); ?></div>
		<div class="cleaner">&nbsp;</div><br/>
		<div class="filterBy filterByFirst">Phone<br/><?php $this->txtPhone->Render('Width=90px'); ?></div>
		<div class="filterBy">City<br/><?php $this->txtCity->Render(); ?></div>
		<div class="filterBy">Zip Code<br/><?php $this->txtZipcode->Render('Width=90px'); ?></div>
		<div class="cleaner">&nbsp;</div><br/>
