...
<?php if (QApplication::IsLoginHasPermission(PermissionType::AddNewIndividual)) { ?>
		<button type="primary" onclick="document.location='/individuals/reports.php'; return false;" class="primary">New Members Report</button>
		<button type="primary" onclick="document.location='/individuals/report_ethnicity.php'; return false;" class="primary">Members Ethnicity Report</button>
<?php } ?>
</div>
